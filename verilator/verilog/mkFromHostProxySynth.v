...
//
// schedule ifc_startPC  CF ( portalIfc_slave_read_server_readReq_put,
// 			   portalIfc_slave_read_server_readData_get,
// 			   portalIfc_slave_write_server_writeReq_put,
// 			   portalIfc_slave_write_server_writeData_put,
// 			   portalIfc_slave_write_server_writeDone_get,
...
module mkFromHostProxySynth(id,
			    CLK,
			    RST_N,
  ...
  reg [31 : 0] v__h2605, x1_avValue_data__h2893;
  wire [31 : 0] v___1__h2693, x1_avValue_data__h2909;
  wire [9 : 0] burstCount___1__h1299,
	       burstCount___1__h693,
	       burstCount__h1257,
	       burstCount__h648;
  wire [4 : 0] addr__h1255, addr__h646;
  wire IF_memslave_fifoReadAddrGenerator_isFirstReg_T_ETC___d21,
       IF_memslave_fifoWriteAddrGenerator_isFirstReg__ETC___d43,
       memslave_rsCtrl_first__7_OR_NOT_memslave_fifoR_ETC___d77;
  ...
  // action method ifc_startPC
  assign RDY_ifc_startPC = dut_RDY_ifc_startPC ;

  // submodule dut
  mkFromHostOutput dut(.CLK(CLK),
		       .RST_N(RST_N),
		       .ifc_startPC_pc(dut_ifc_startPC_pc),
		       ...
		       .EN_ifc_startPC(dut_EN_ifc_startPC),
		       ...
		       .RDY_ifc_startPC(dut_RDY_ifc_startPC));
  ...
  // register memslave_fifoReadAddrGenerator_addrReg
  assign memslave_fifoReadAddrGenerator_addrReg_D_IN = addr__h646 + 5'd4 ;
  ...
  assign memslave_fifoReadAddrGenerator_isLastReg_D_IN =
	     burstCount__h648 == 10'd2 ;
  assign memslave_fifoReadAddrGenerator_isLastReg_EN =
	     memslave_fifoReadAddrGenerator_requestFifo_EMPTY_N &&
	     memslave_fifoReadAddrGenerator_addrBeatFifo_FULL_N ;

  // register memslave_fifoWriteAddrGenerator_addrReg
  assign memslave_fifoWriteAddrGenerator_addrReg_D_IN = addr__h1255 + 5'd4 ;
  ...
  assign memslave_rsCtrl_first__7_OR_NOT_memslave_fifoR_ETC___d77 =
	     ...
	     (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17] !=
	      5'd0 ||
	      dut_RDY_portalIfc_indications_0_first) ;
  assign v___1__h2693 = dut_portalIfc_intr_channel + 32'd1 ;
  assign x1_avValue_data__h2909 =
	     memslave_rsCtrl_D_OUT ? v__h2605 : x1_avValue_data__h2893 ;
  ...
  begin
    case (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17])
      5'd0: v__h2605 = dut_portalIfc_intr_status ? 32'd1 : 32'd0;
      5'd4: v__h2605 = ctrlPort_interruptEnableReg ? 32'd1 : 32'd0;
      5'd8: v__h2605 = 32'd2;
      5'h0C: v__h2605 = dut_portalIfc_intr_status ? v___1__h2693 : 32'd0;
      5'h10: v__h2605 = id;
      5'h14: v__h2605 = ctrlPort_num_portals_reg;
      5'h18: v__h2605 = ctrlPort_cycle_count[63:32];
      5'h1C: v__h2605 = ctrlPort_snapshot;
      default: v__h2605 = 32'h005A05A0;
    endcase
  end
  always@(memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT or
  ...
  begin
    case (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17])
      5'd0: x1_avValue_data__h2893 = dut_portalIfc_indications_0_first;
      5'd4:
	  x1_avValue_data__h2893 =
	      { 31'd0, dut_portalIfc_indications_0_notEmpty };
      default: x1_avValue_data__h2893 = 32'd0;
    endcase
  end
  ...
  // synopsys translate_on
endmodule  // mkFromHostProxySynth
