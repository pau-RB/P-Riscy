...
// schedule pipes_print_PipeOut_first  CF ( pipes_print_PipeOut_first,
...
//
// schedule pipes_print_PipeOut_deq  CF ( portalIfc_slave_read_server_readReq_put,
// 				       portalIfc_slave_read_server_readData_get,
// 				       portalIfc_slave_write_server_writeReq_put,
// 				       portalIfc_slave_write_server_writeData_put,
// 				       portalIfc_slave_write_server_writeDone_get,
...
//
// schedule pipes_print_PipeOut_notEmpty  CF ( pipes_print_PipeOut_first,
// 					    pipes_print_PipeOut_notEmpty,
// 					    portalIfc_slave_read_server_readReq_put,
// 					    portalIfc_slave_read_server_readData_get,
// 					    portalIfc_slave_write_server_writeReq_put,
...
// 					    portalIfc_interrupt__read,
// 					    portalIfc_num_portals__write );
// schedule pipes_print_PipeOut_notEmpty  SBR ( pipes_print_PipeOut_deq );
//
// schedule portalIfc_slave_read_server_readReq_put  CF ( pipes_print_PipeOut_first,
...
//
// schedule portalIfc_slave_read_server_readData_get  CF ( pipes_print_PipeOut_first,
// 							pipes_print_PipeOut_deq,
// 							pipes_print_PipeOut_notEmpty,
// 							portalIfc_slave_read_server_readReq_put,
// 							portalIfc_slave_write_server_writeReq_put,
...
//
// schedule portalIfc_slave_write_server_writeReq_put  CF ( pipes_print_PipeOut_first,
// 							 pipes_print_PipeOut_deq,
// 							 pipes_print_PipeOut_notEmpty,
// 							 portalIfc_slave_read_server_readReq_put,
// 							 portalIfc_slave_read_server_readData_get,
...
//
// schedule portalIfc_slave_write_server_writeData_put  CF ( pipes_print_PipeOut_first,
// 							  pipes_print_PipeOut_deq,
// 							  pipes_print_PipeOut_notEmpty,
// 							  portalIfc_slave_read_server_readReq_put,
// 							  portalIfc_slave_read_server_readData_get,
...
//
// schedule portalIfc_slave_write_server_writeDone_get  CF ( pipes_print_PipeOut_first,
// 							  pipes_print_PipeOut_deq,
// 							  pipes_print_PipeOut_notEmpty,
// 							  portalIfc_slave_read_server_readReq_put,
// 							  portalIfc_slave_read_server_readData_get,
...
//
// schedule portalIfc_interrupt__read  CF ( pipes_print_PipeOut_first,
// 					 pipes_print_PipeOut_notEmpty,
// 					 portalIfc_slave_read_server_readReq_put,
// 					 portalIfc_slave_read_server_readData_get,
// 					 portalIfc_slave_write_server_writeReq_put,
...
// 					 portalIfc_interrupt__read,
// 					 portalIfc_num_portals__write );
// schedule portalIfc_interrupt__read  SBR ( pipes_print_PipeOut_deq );
//
// schedule portalIfc_num_portals__write  CF ( pipes_print_PipeOut_first,
// 					    pipes_print_PipeOut_deq,
// 					    pipes_print_PipeOut_notEmpty,
// 					    portalIfc_slave_read_server_readReq_put,
// 					    portalIfc_slave_read_server_readData_get,
...
module mkToHostWrapperMemPortalPipes(id,
				     CLK,
				     RST_N,
  ...
  wire [31 : 0] pipes_print_PipeOut_first;
  ...
  reg [31 : 0] v__h2997;
  wire [31 : 0] v___1__h2984, v___1__h3085;
  wire [9 : 0] burstCount___1__h1308,
	       burstCount___1__h702,
	       burstCount__h1266,
	       burstCount__h657;
  wire [4 : 0] addr__h1264, addr__h655;
  wire IF_memslave_fifoReadAddrGenerator_isFirstReg_T_ETC___d21,
       IF_memslave_fifoWriteAddrGenerator_isFirstReg__ETC___d43,
       memslave_fifoWriteAddrGenerator_addrBeatFifo_i_ETC___d74;

  // value method pipes_print_PipeOut_first
  assign pipes_print_PipeOut_first = dut_pipes_print_PipeOut_first ;
  assign RDY_pipes_print_PipeOut_first = dut_RDY_pipes_print_PipeOut_first ;

  // action method pipes_print_PipeOut_deq
  assign RDY_pipes_print_PipeOut_deq = dut_RDY_pipes_print_PipeOut_deq ;

  // value method pipes_print_PipeOut_notEmpty
  assign pipes_print_PipeOut_notEmpty = dut_pipes_print_PipeOut_notEmpty ;
  ...
  mkToHostInput dut(.CLK(CLK),
		    ...
		    .EN_pipes_print_PipeOut_deq(dut_EN_pipes_print_PipeOut_deq),
		    ...
		    .pipes_print_PipeOut_first(dut_pipes_print_PipeOut_first),
		    .RDY_pipes_print_PipeOut_first(dut_RDY_pipes_print_PipeOut_first),
		    .RDY_pipes_print_PipeOut_deq(dut_RDY_pipes_print_PipeOut_deq),
		    .pipes_print_PipeOut_notEmpty(dut_pipes_print_PipeOut_notEmpty),
		    .RDY_pipes_print_PipeOut_notEmpty());
  ...
  FIFO10 #(.guarded(1'd1)) memslave_rs(.RST(RST_N),
				       .CLK(CLK),
				       .ENQ(memslave_rs_ENQ),
				       .DEQ(memslave_rs_DEQ),
				       .CLR(memslave_rs_CLR),
  ...
  FIFO10 #(.guarded(1'd1)) memslave_ws(.RST(RST_N),
				       .CLK(CLK),
				       .ENQ(memslave_ws_ENQ),
				       .DEQ(memslave_ws_DEQ),
				       .CLR(memslave_ws_CLR),
  ...
  // register memslave_fifoReadAddrGenerator_addrReg
  assign memslave_fifoReadAddrGenerator_addrReg_D_IN = addr__h655 + 5'd4 ;
  ...
  assign memslave_fifoReadAddrGenerator_isLastReg_D_IN =
	     burstCount__h657 == 10'd2 ;
  assign memslave_fifoReadAddrGenerator_isLastReg_EN =
	     memslave_fifoReadAddrGenerator_requestFifo_EMPTY_N &&
	     memslave_fifoReadAddrGenerator_addrBeatFifo_FULL_N ;

  // register memslave_fifoWriteAddrGenerator_addrReg
  assign memslave_fifoWriteAddrGenerator_addrReg_D_IN = addr__h1264 + 5'd4 ;
  ...
  assign dut_EN_portalIfc_requests_0_enq =
	     WILL_FIRE_RL_memslave_writeDataRule && !memslave_wsCtrl_D_OUT ;
  assign dut_EN_pipes_print_PipeOut_deq = EN_pipes_print_PipeOut_deq ;
  ...
  assign burstCount___1__h1308 =
	     { 2'd0,
	       memslave_fifoWriteAddrGenerator_requestFifo_D_OUT[15:8] } ;
  assign burstCount___1__h702 =
	     { 2'd0,
	       memslave_fifoReadAddrGenerator_requestFifo_D_OUT[15:8] } ;
  assign burstCount__h1266 =
	     memslave_fifoWriteAddrGenerator_isFirstReg ?
	       burstCount___1__h1308 :
	       memslave_fifoWriteAddrGenerator_burstCountReg ;
  assign burstCount__h657 =
	     memslave_fifoReadAddrGenerator_isFirstReg ?
	       burstCount___1__h702 :
	       memslave_fifoReadAddrGenerator_burstCountReg ;
  assign memslave_fifoWriteAddrGenerator_addrBeatFifo_i_ETC___d74 =
	     memslave_fifoWriteAddrGenerator_addrBeatFifo_EMPTY_N &&
	     (!memslave_fifoWriteAddrGenerator_addrBeatFifo_D_OUT[0] ||
	      memslave_fifoWriteDoneFifo_FULL_N) &&
	     (memslave_wsCtrl_D_OUT || dut_RDY_portalIfc_requests_0_enq) ;
  assign v___1__h2984 =
	     memslave_rsCtrl_D_OUT ?
	       v__h2997 :
	       ((memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17] ==
		 5'd4) ?
		  { 31'd0, dut_portalIfc_requests_0_notFull } :
		  32'd0) ;
  assign v___1__h3085 = dut_portalIfc_intr_channel + 32'd1 ;
  ...
  begin
    case (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17])
      5'd0: v__h2997 = dut_portalIfc_intr_status ? 32'd1 : 32'd0;
      5'd4: v__h2997 = ctrlPort_interruptEnableReg ? 32'd1 : 32'd0;
      5'd8: v__h2997 = 32'd2;
      5'h0C: v__h2997 = dut_portalIfc_intr_status ? v___1__h3085 : 32'd0;
      5'h10: v__h2997 = id;
      5'h14: v__h2997 = ctrlPort_num_portals_reg;
      5'h18: v__h2997 = ctrlPort_cycle_count[63:32];
      5'h1C: v__h2997 = ctrlPort_snapshot;
      default: v__h2997 = 32'h005A05A0;
    endcase
  end
  ...
  // synopsys translate_on
endmodule  // mkToHostWrapperMemPortalPipes
