...
//
// schedule ifc_addrTrans  CF ( portalIfc_slave_read_server_readReq_put,
// 			     portalIfc_slave_read_server_readData_get,
// 			     portalIfc_slave_write_server_writeReq_put,
// 			     portalIfc_slave_write_server_writeData_put,
// 			     portalIfc_slave_write_server_writeDone_get,
...
//
// schedule ifc_setTileState  CF ( portalIfc_slave_read_server_readReq_put,
// 				portalIfc_slave_read_server_readData_get,
// 				portalIfc_slave_write_server_writeReq_put,
// 				portalIfc_slave_write_server_writeData_put,
// 				portalIfc_slave_write_server_writeDone_get,
...
//
// schedule ifc_stateDbg  CF ( portalIfc_slave_read_server_readReq_put,
// 			    portalIfc_slave_read_server_readData_get,
// 			    portalIfc_slave_write_server_writeReq_put,
// 			    portalIfc_slave_write_server_writeData_put,
// 			    portalIfc_slave_write_server_writeDone_get,
...
//
// schedule ifc_memoryTraffic  CF ( portalIfc_slave_read_server_readReq_put,
// 				 portalIfc_slave_read_server_readData_get,
// 				 portalIfc_slave_write_server_writeReq_put,
// 				 portalIfc_slave_write_server_writeData_put,
// 				 portalIfc_slave_write_server_writeDone_get,
...
module mkMemServerRequestProxySynth(id,
				    CLK,
				    RST_N,
  ...
  wire [31 : 0] dut_ifc_addrTrans_offset,
		dut_ifc_addrTrans_sglId,
  ...
  wire [3 : 0] dut_ifc_setTileState_tc;
  wire dut_EN_ifc_addrTrans,
       dut_EN_ifc_memoryTraffic,
       dut_EN_ifc_setTileState,
       dut_EN_ifc_stateDbg,
       ...
       dut_RDY_ifc_addrTrans,
       dut_RDY_ifc_memoryTraffic,
       dut_RDY_ifc_setTileState,
       dut_RDY_ifc_stateDbg,
  ...
  reg [31 : 0] v__h2693, v__h2848, x1_avValue_data__h3142;
  reg CASE_memslave_rs_first__2_0_dut_RDY_portalIfc__ETC___d77,
      CASE_memslave_rs_first__2_0_dut_RDY_portalIfc__ETC___d83,
      x__h3185;
  wire [31 : 0] v___1__h2781, x1_avValue_data__h3158;
  wire [9 : 0] burstCount___1__h1379,
	       burstCount___1__h773,
	       burstCount__h1337,
	       burstCount__h728;
  wire [6 : 0] x__h3454, x__h3718;
  wire [4 : 0] addr__h1335, addr__h726;
  wire IF_memslave_fifoReadAddrGenerator_isFirstReg_T_ETC___d21,
       IF_memslave_fifoWriteAddrGenerator_isFirstReg__ETC___d43,
       memslave_rsCtrl_first__7_OR_NOT_memslave_fifoR_ETC___d86;
  ...
  // action method ifc_addrTrans
  assign RDY_ifc_addrTrans = dut_RDY_ifc_addrTrans ;

  // action method ifc_setTileState
  assign RDY_ifc_setTileState = dut_RDY_ifc_setTileState ;

  // action method ifc_stateDbg
  assign RDY_ifc_stateDbg = dut_RDY_ifc_stateDbg ;

  // action method ifc_memoryTraffic
  assign RDY_ifc_memoryTraffic = dut_RDY_ifc_memoryTraffic ;

  // submodule dut
  mkMemServerRequestOutput dut(.CLK(CLK),
			       .RST_N(RST_N),
			       .ifc_addrTrans_offset(dut_ifc_addrTrans_offset),
			       .ifc_addrTrans_sglId(dut_ifc_addrTrans_sglId),
			       .ifc_memoryTraffic_rc(dut_ifc_memoryTraffic_rc),
			       .ifc_setTileState_tc(dut_ifc_setTileState_tc),
			       .ifc_stateDbg_rc(dut_ifc_stateDbg_rc),
			       ...
			       .EN_ifc_addrTrans(dut_EN_ifc_addrTrans),
			       .EN_ifc_setTileState(dut_EN_ifc_setTileState),
			       .EN_ifc_stateDbg(dut_EN_ifc_stateDbg),
			       .EN_ifc_memoryTraffic(dut_EN_ifc_memoryTraffic),
			       ...
			       .RDY_ifc_addrTrans(dut_RDY_ifc_addrTrans),
			       .RDY_ifc_setTileState(dut_RDY_ifc_setTileState),
			       .RDY_ifc_stateDbg(dut_RDY_ifc_stateDbg),
			       .RDY_ifc_memoryTraffic(dut_RDY_ifc_memoryTraffic));
  ...
  // register memslave_fifoReadAddrGenerator_addrReg
  assign memslave_fifoReadAddrGenerator_addrReg_D_IN = addr__h726 + 5'd4 ;
  ...
  assign memslave_fifoReadAddrGenerator_isLastReg_D_IN =
	     burstCount__h728 == 10'd2 ;
  assign memslave_fifoReadAddrGenerator_isLastReg_EN =
	     memslave_fifoReadAddrGenerator_requestFifo_EMPTY_N &&
	     memslave_fifoReadAddrGenerator_addrBeatFifo_FULL_N ;

  // register memslave_fifoWriteAddrGenerator_addrReg
  assign memslave_fifoWriteAddrGenerator_addrReg_D_IN = addr__h1335 + 5'd4 ;
  ...
  assign memslave_fifoWriteAddrGenerator_isLastReg_D_IN =
	     burstCount__h1337 == 10'd2 ;
  assign memslave_fifoWriteAddrGenerator_isLastReg_EN =
	     memslave_fifoWriteAddrGenerator_requestFifo_EMPTY_N &&
	     memslave_fifoWriteAddrGenerator_addrBeatFifo_FULL_N ;

  // submodule dut
  assign dut_ifc_addrTrans_offset = ifc_addrTrans_offset ;
  assign dut_ifc_addrTrans_sglId = ifc_addrTrans_sglId ;
  assign dut_ifc_memoryTraffic_rc = ifc_memoryTraffic_rc ;
  assign dut_ifc_setTileState_tc = ifc_setTileState_tc ;
  assign dut_ifc_stateDbg_rc = ifc_stateDbg_rc ;
  ...
  assign dut_EN_portalIfc_indications_3_deq =
	     WILL_FIRE_RL_memslave_rvrule && memslave_rs_D_OUT == 2'd3 &&
	     !memslave_rsCtrl_D_OUT &&
	     memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17] ==
	     5'd0 ;
  assign dut_EN_ifc_addrTrans = EN_ifc_addrTrans ;
  assign dut_EN_ifc_setTileState = EN_ifc_setTileState ;
  assign dut_EN_ifc_stateDbg = EN_ifc_stateDbg ;
  assign dut_EN_ifc_memoryTraffic = EN_ifc_memoryTraffic ;
  ...
  // submodule memslave_rs
  assign memslave_rs_D_IN = x__h3454[1:0] ;
  ...
  // submodule memslave_ws
  assign memslave_ws_D_IN = x__h3718[1:0] ;
  ...
  assign burstCount___1__h1379 =
	     { 2'd0,
	       memslave_fifoWriteAddrGenerator_requestFifo_D_OUT[15:8] } ;
  assign burstCount___1__h773 =
	     { 2'd0,
	       memslave_fifoReadAddrGenerator_requestFifo_D_OUT[15:8] } ;
  assign burstCount__h1337 =
	     memslave_fifoWriteAddrGenerator_isFirstReg ?
	       burstCount___1__h1379 :
	       memslave_fifoWriteAddrGenerator_burstCountReg ;
  assign burstCount__h728 =
	     memslave_fifoReadAddrGenerator_isFirstReg ?
	       burstCount___1__h773 :
	       memslave_fifoReadAddrGenerator_burstCountReg ;
  assign memslave_rsCtrl_first__7_OR_NOT_memslave_fifoR_ETC___d86 =
	     memslave_rsCtrl_D_OUT ||
	     (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17] !=
	      5'd0 ||
	      CASE_memslave_rs_first__2_0_dut_RDY_portalIfc__ETC___d77) &&
	     (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17] !=
	      5'd0 ||
	      CASE_memslave_rs_first__2_0_dut_RDY_portalIfc__ETC___d83) ;
  assign v___1__h2781 = dut_portalIfc_intr_channel + 32'd1 ;
  assign x1_avValue_data__h3158 =
	     memslave_rsCtrl_D_OUT ? v__h2693 : x1_avValue_data__h3142 ;
  assign x__h3454 = portalIfc_slave_read_server_readReq_put[27:21] - 7'd1 ;
  assign x__h3718 = portalIfc_slave_write_server_writeReq_put[27:21] - 7'd1 ;
  ...
  begin
    case (memslave_rs_D_OUT)
      2'd0: v__h2848 = dut_portalIfc_indications_0_first;
      2'd1: v__h2848 = dut_portalIfc_indications_1_first;
      2'd2: v__h2848 = dut_portalIfc_indications_2_first;
      2'd3: v__h2848 = dut_portalIfc_indications_3_first;
    endcase
  end
  ...
  begin
    case (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17])
      5'd0: v__h2693 = dut_portalIfc_intr_status ? 32'd1 : 32'd0;
      5'd4: v__h2693 = ctrlPort_interruptEnableReg ? 32'd1 : 32'd0;
      5'd8: v__h2693 = 32'd2;
      5'h0C: v__h2693 = dut_portalIfc_intr_status ? v___1__h2781 : 32'd0;
      5'h10: v__h2693 = id;
      5'h14: v__h2693 = ctrlPort_num_portals_reg;
      5'h18: v__h2693 = ctrlPort_cycle_count[63:32];
      5'h1C: v__h2693 = ctrlPort_snapshot;
      default: v__h2693 = 32'h005A05A0;
    endcase
  end
  always@(memslave_rs_D_OUT or
  ...
  begin
    case (memslave_rs_D_OUT)
      2'd0: x__h3185 = dut_portalIfc_indications_0_notEmpty;
      2'd1: x__h3185 = dut_portalIfc_indications_1_notEmpty;
      2'd2: x__h3185 = dut_portalIfc_indications_2_notEmpty;
      2'd3: x__h3185 = dut_portalIfc_indications_3_notEmpty;
    endcase
  end
  always@(memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT or
	  v__h2848 or x__h3185)
  begin
    case (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17])
      5'd0: x1_avValue_data__h3142 = v__h2848;
      5'd4: x1_avValue_data__h3142 = { 31'd0, x__h3185 };
      default: x1_avValue_data__h3142 = 32'd0;
    endcase
  end
  always@(memslave_rs_D_OUT or
  ...
  // synopsys translate_on
endmodule  // mkMemServerRequestProxySynth
