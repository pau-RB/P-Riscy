...
//
// schedule ifc_addrResponse  CF ( portalIfc_slave_read_server_readReq_put,
// 				portalIfc_slave_read_server_readData_get,
// 				portalIfc_slave_write_server_writeReq_put,
// 				portalIfc_slave_write_server_writeData_put,
// 				portalIfc_slave_write_server_writeDone_get,
...
//
// schedule ifc_reportStateDbg  CF ( portalIfc_slave_read_server_readReq_put,
// 				  portalIfc_slave_read_server_readData_get,
// 				  portalIfc_slave_write_server_writeReq_put,
// 				  portalIfc_slave_write_server_writeData_put,
// 				  portalIfc_slave_write_server_writeDone_get,
...
//
// schedule ifc_reportMemoryTraffic  CF ( portalIfc_slave_read_server_readReq_put,
// 				       portalIfc_slave_read_server_readData_get,
// 				       portalIfc_slave_write_server_writeReq_put,
// 				       portalIfc_slave_write_server_writeData_put,
// 				       portalIfc_slave_write_server_writeDone_get,
...
module mkMemServerIndicationProxySynth(id,
				       CLK,
				       RST_N,
  ...
  wire [127 : 0] dut_ifc_reportStateDbg_rec;
  wire [63 : 0] dut_ifc_addrResponse_physAddr,
		dut_ifc_error_extra,
		dut_ifc_error_offset,
		dut_ifc_reportMemoryTraffic_words;
  wire [31 : 0] dut_ifc_error_code,
		dut_ifc_error_sglId,
  ...
  wire dut_EN_ifc_addrResponse,
       dut_EN_ifc_error,
       dut_EN_ifc_reportMemoryTraffic,
       dut_EN_ifc_reportStateDbg,
       ...
       dut_RDY_ifc_addrResponse,
       dut_RDY_ifc_error,
       dut_RDY_ifc_reportMemoryTraffic,
       dut_RDY_ifc_reportStateDbg,
  ...
  reg [31 : 0] v__h2709, v__h2864, x1_avValue_data__h3158;
  reg CASE_memslave_rs_first__2_0_dut_RDY_portalIfc__ETC___d77,
      CASE_memslave_rs_first__2_0_dut_RDY_portalIfc__ETC___d83,
      x__h3201;
  wire [31 : 0] v___1__h2797, x1_avValue_data__h3174;
  wire [9 : 0] burstCount___1__h1395,
	       burstCount___1__h789,
	       burstCount__h1353,
	       burstCount__h744;
  wire [6 : 0] x__h3470, x__h3734;
  wire [4 : 0] addr__h1351, addr__h742;
  ...
  // action method ifc_addrResponse
  assign RDY_ifc_addrResponse = dut_RDY_ifc_addrResponse ;

  // action method ifc_reportStateDbg
  assign RDY_ifc_reportStateDbg = dut_RDY_ifc_reportStateDbg ;

  // action method ifc_reportMemoryTraffic
  assign RDY_ifc_reportMemoryTraffic = dut_RDY_ifc_reportMemoryTraffic ;

  // action method ifc_error
  assign RDY_ifc_error = dut_RDY_ifc_error ;

  // submodule dut
  mkMemServerIndicationOutput dut(.CLK(CLK),
				  .RST_N(RST_N),
				  .ifc_addrResponse_physAddr(dut_ifc_addrResponse_physAddr),
				  ...
				  .ifc_reportMemoryTraffic_words(dut_ifc_reportMemoryTraffic_words),
				  .ifc_reportStateDbg_rec(dut_ifc_reportStateDbg_rec),
				  ...
				  .EN_ifc_addrResponse(dut_EN_ifc_addrResponse),
				  .EN_ifc_reportStateDbg(dut_EN_ifc_reportStateDbg),
				  .EN_ifc_reportMemoryTraffic(dut_EN_ifc_reportMemoryTraffic),
				  ...
				  .RDY_ifc_addrResponse(dut_RDY_ifc_addrResponse),
				  .RDY_ifc_reportStateDbg(dut_RDY_ifc_reportStateDbg),
				  .RDY_ifc_reportMemoryTraffic(dut_RDY_ifc_reportMemoryTraffic),
  ...
  // register memslave_fifoReadAddrGenerator_addrReg
  assign memslave_fifoReadAddrGenerator_addrReg_D_IN = addr__h742 + 5'd4 ;
  ...
  assign memslave_fifoReadAddrGenerator_isLastReg_D_IN =
	     burstCount__h744 == 10'd2 ;
  assign memslave_fifoReadAddrGenerator_isLastReg_EN =
	     memslave_fifoReadAddrGenerator_requestFifo_EMPTY_N &&
	     memslave_fifoReadAddrGenerator_addrBeatFifo_FULL_N ;

  // register memslave_fifoWriteAddrGenerator_addrReg
  assign memslave_fifoWriteAddrGenerator_addrReg_D_IN = addr__h1351 + 5'd4 ;
  ...
  assign memslave_fifoWriteAddrGenerator_isLastReg_D_IN =
	     burstCount__h1353 == 10'd2 ;
  assign memslave_fifoWriteAddrGenerator_isLastReg_EN =
	     memslave_fifoWriteAddrGenerator_requestFifo_EMPTY_N &&
	     memslave_fifoWriteAddrGenerator_addrBeatFifo_FULL_N ;

  // submodule dut
  assign dut_ifc_addrResponse_physAddr = ifc_addrResponse_physAddr ;
  ...
  assign dut_ifc_reportMemoryTraffic_words = ifc_reportMemoryTraffic_words ;
  assign dut_ifc_reportStateDbg_rec = ifc_reportStateDbg_rec ;
  ...
  assign dut_EN_portalIfc_indications_3_deq =
	     ...
	     memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17] ==
	     5'd0 ;
  assign dut_EN_ifc_addrResponse = EN_ifc_addrResponse ;
  assign dut_EN_ifc_reportStateDbg = EN_ifc_reportStateDbg ;
  assign dut_EN_ifc_reportMemoryTraffic = EN_ifc_reportMemoryTraffic ;
  ...
  // submodule memslave_rs
  assign memslave_rs_D_IN = x__h3470[1:0] ;
  ...
  // submodule memslave_ws
  assign memslave_ws_D_IN = x__h3734[1:0] ;
  ...
  assign memslave_rsCtrl_first__7_OR_NOT_memslave_fifoR_ETC___d86 =
	     ...
	     (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17] !=
	      5'd0 ||
	      CASE_memslave_rs_first__2_0_dut_RDY_portalIfc__ETC___d83) ;
  assign v___1__h2797 = dut_portalIfc_intr_channel + 32'd1 ;
  assign x1_avValue_data__h3174 =
	     memslave_rsCtrl_D_OUT ? v__h2709 : x1_avValue_data__h3158 ;
  assign x__h3470 = portalIfc_slave_read_server_readReq_put[27:21] - 7'd1 ;
  assign x__h3734 = portalIfc_slave_write_server_writeReq_put[27:21] - 7'd1 ;
  ...
  begin
    case (memslave_rs_D_OUT)
      2'd0: v__h2864 = dut_portalIfc_indications_0_first;
      2'd1: v__h2864 = dut_portalIfc_indications_1_first;
      2'd2: v__h2864 = dut_portalIfc_indications_2_first;
      2'd3: v__h2864 = dut_portalIfc_indications_3_first;
    endcase
  end
  ...
  begin
    case (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17])
      5'd0: v__h2709 = dut_portalIfc_intr_status ? 32'd1 : 32'd0;
      5'd4: v__h2709 = ctrlPort_interruptEnableReg ? 32'd1 : 32'd0;
      5'd8: v__h2709 = 32'd2;
      5'h0C: v__h2709 = dut_portalIfc_intr_status ? v___1__h2797 : 32'd0;
      5'h10: v__h2709 = id;
      5'h14: v__h2709 = ctrlPort_num_portals_reg;
      5'h18: v__h2709 = ctrlPort_cycle_count[63:32];
      5'h1C: v__h2709 = ctrlPort_snapshot;
      default: v__h2709 = 32'h005A05A0;
    endcase
  end
  always@(memslave_rs_D_OUT or
  ...
  begin
    case (memslave_rs_D_OUT)
      2'd0: x__h3201 = dut_portalIfc_indications_0_notEmpty;
      2'd1: x__h3201 = dut_portalIfc_indications_1_notEmpty;
      2'd2: x__h3201 = dut_portalIfc_indications_2_notEmpty;
      2'd3: x__h3201 = dut_portalIfc_indications_3_notEmpty;
    endcase
  end
  always@(memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT or
	  v__h2864 or x__h3201)
  begin
    case (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17])
      5'd0: x1_avValue_data__h3158 = v__h2864;
      5'd4: x1_avValue_data__h3158 = { 31'd0, x__h3201 };
      default: x1_avValue_data__h3158 = 32'd0;
    endcase
  end
  always@(memslave_rs_D_OUT or
  ...
  // synopsys translate_on
endmodule  // mkMemServerIndicationProxySynth
