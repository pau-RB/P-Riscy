...
//
// schedule ifc_print  CF ( portalIfc_slave_read_server_readReq_put,
// 			 portalIfc_slave_read_server_readData_get,
// 			 portalIfc_slave_write_server_writeReq_put,
// 			 portalIfc_slave_write_server_writeData_put,
// 			 portalIfc_slave_write_server_writeDone_get,
...
module mkToHostProxySynth(id,
  ...
  // action method ifc_print
  assign RDY_ifc_print = dut_RDY_ifc_print ;

  // submodule dut
  mkToHostOutput dut(.CLK(CLK),
		     .RST_N(RST_N),
		     .ifc_print_word(dut_ifc_print_word),
		     ...
		     .RDY_ifc_print(dut_RDY_ifc_print));
