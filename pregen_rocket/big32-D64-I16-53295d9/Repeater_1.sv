...
module Repeater_1(
  ...
  always @(posedge clock) begin
    ...
    if (_T_1) begin	// src/main/scala/util/Repeater.scala:28:21
      ...
      saved_sink <= io_enq_bits_sink;	// src/main/scala/util/Repeater.scala:20:18
      saved_denied <= io_enq_bits_denied;	// src/main/scala/util/Repeater.scala:20:18
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_size = _RANDOM[5'h0][9:6];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_source = _RANDOM[5'h0][13:10];	// src/main/scala/util/Repeater.scala:19:21, :20:18
  ...
  assign io_deq_bits_sink = full ? saved_sink : io_enq_bits_sink;	// src/main/scala/util/Repeater.scala:19:21, :20:18, :25:21
  assign io_deq_bits_denied = full ? saved_denied : io_enq_bits_denied;	// src/main/scala/util/Repeater.scala:19:21, :20:18, :25:21
