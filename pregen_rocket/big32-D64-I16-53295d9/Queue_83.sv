...
module Queue_83(
  ...
  input  [9:0]  io_enq_bits_extra_tlrr_extra_source,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  output [9:0]  io_deq_bits_extra_tlrr_extra_source,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
    ...
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:281:27
      ram <=
        {io_enq_bits_extra_tlrr_extra_size,
         ...
         io_enq_bits_data,
         io_enq_bits_index,
         io_enq_bits_read};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    if (reset)
  ...
  assign io_deq_bits_extra_tlrr_extra_source = ram[70:61];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_extra_tlrr_extra_size = ram[72:71];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
