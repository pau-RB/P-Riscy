...
module mem_combMem_0(	// src/main/scala/util/DescribedSRAM.scala:17:26
  input  [25:0] R0_addr,
  input         R0_en,
                R0_clk,
  input  [25:0] W0_addr,
  ...
  reg [31:0] Memory[0:67108863];	// src/main/scala/util/DescribedSRAM.scala:17:26
  reg        _GEN;	// src/main/scala/util/DescribedSRAM.scala:17:26
  reg [25:0] _GEN_0;	// src/main/scala/util/DescribedSRAM.scala:17:26
  ...
  `ifndef SYNTHESIS	// src/main/scala/util/DescribedSRAM.scala:17:26
    ...
    initial begin	// src/main/scala/util/DescribedSRAM.scala:17:26
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/util/DescribedSRAM.scala:17:26
        ...
        _GEN_0 = _RANDOM[26:1];	// src/main/scala/util/DescribedSRAM.scala:17:26
      `endif // RANDOMIZE_REG_INIT
    end // initial
  `endif // not def SYNTHESIS
  assign R0_data = _GEN ? Memory[_GEN_0] : 32'bx;	// src/main/scala/util/DescribedSRAM.scala:17:26
endmodule
