...
module TLFragmenter_3(
  ...
  input  [9:0]  auto_out_d_bits_source,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  output [9:0]  auto_out_a_bits_source,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  output [16:0] auto_out_a_bits_address,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  wire [16:0] _repeater_io_deq_bits_address;	// src/main/scala/tilelink/Fragmenter.scala:264:30
  wire [3:0]  _repeater_io_deq_bits_mask;	// src/main/scala/tilelink/Fragmenter.scala:264:30
  ...
  wire [9:0]  nodeOut_d_bits_source = auto_out_d_bits_source;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire [31:0] nodeOut_d_bits_data = auto_out_d_bits_data;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire        dHasData_opdata = 1'h1;	// src/main/scala/tilelink/Edges.scala:107:36
  wire        ack_decrement = 1'h1;	// src/main/scala/tilelink/Fragmenter.scala:206:32
  ...
  wire        drop = 1'h0;	// src/main/scala/tilelink/Fragmenter.scala:224:30
  ...
  wire [2:0]  nodeOut_d_bits_opcode = 3'h1;	// src/main/scala/diplomacy/LazyModule.scala:374:18, src/main/scala/diplomacy/Nodes.scala:1205:17
  wire [1:0]  limit = 2'h2;	// src/main/scala/chisel3/util/Mux.scala:77:13
  ...
  reg  [3:0]  acknum;	// src/main/scala/tilelink/Fragmenter.scala:191:29
  reg  [2:0]  dOrig;	// src/main/scala/tilelink/Fragmenter.scala:192:24
  reg         dToggle;	// src/main/scala/tilelink/Fragmenter.scala:193:30
  wire [3:0]  dFragnum = nodeOut_d_bits_source[3:0];	// src/main/scala/diplomacy/Nodes.scala:1205:17, src/main/scala/tilelink/Fragmenter.scala:194:41
  wire [3:0]  acknum_fragment = dFragnum;	// src/main/scala/tilelink/Fragmenter.scala:194:41, :202:40
  wire        dFirst = acknum == 4'h0;	// src/main/scala/tilelink/Fragmenter.scala:191:29, :195:29
  wire        dLast = dFragnum == 4'h0;	// src/main/scala/tilelink/Fragmenter.scala:191:29, :194:41, :196:30
  wire [3:0]  _dsizeOH_T = 4'h1 << dsizeOH_shiftAmount;	// src/main/scala/chisel3/util/OneHot.scala:64:49, :65:12
  wire [2:0]  dsizeOH = _dsizeOH_T[2:0];	// src/main/scala/chisel3/util/OneHot.scala:65:{12,27}
  wire [4:0]  _dsizeOH1_T_1 = 5'h3 << nodeOut_d_bits_size;	// src/main/scala/diplomacy/Nodes.scala:1205:17, src/main/scala/util/package.scala:243:71
  wire [1:0]  dsizeOH1 = ~(_dsizeOH1_T_1[1:0]);	// src/main/scala/util/package.scala:243:{46,71,76}
  wire [3:0]  dFirst_acknum = acknum_fragment;	// src/main/scala/tilelink/Fragmenter.scala:202:40, :205:45
  wire [6:0]  _dFirst_size_T_6 =
    {dFragnum, dsizeOH1, 1'h1} & {1'h1, ~dFragnum, ~dsizeOH1};	// src/main/scala/tilelink/Fragmenter.scala:194:41, src/main/scala/util/package.scala:241:{40,47,49,53}, :243:46
  wire [2:0]  dFirst_size_hi = _dFirst_size_T_6[6:4];	// src/main/scala/chisel3/util/OneHot.scala:30:18, src/main/scala/util/package.scala:241:47
  wire [3:0]  dFirst_size_lo = _dFirst_size_T_6[3:0];	// src/main/scala/chisel3/util/OneHot.scala:31:18, src/main/scala/util/package.scala:241:47
  ...
  wire [4:0]  nodeIn_d_bits_source = nodeOut_d_bits_source[9:5];	// src/main/scala/diplomacy/Nodes.scala:1205:17, :1214:17, src/main/scala/tilelink/Fragmenter.scala:228:47
  ...
  wire [2:0]  aFrag =
    _repeater_io_deq_bits_size > 3'h2 ? 3'h2 : _repeater_io_deq_bits_size;	// src/main/scala/tilelink/Fragmenter.scala:264:30, :287:{24,31}
  wire [12:0] _aOrigOH1_T_1 = 13'h3F << _repeater_io_deq_bits_size;	// src/main/scala/tilelink/Fragmenter.scala:264:30, src/main/scala/util/package.scala:243:71
  wire [5:0]  aOrigOH1 = ~(_aOrigOH1_T_1[5:0]);	// src/main/scala/util/package.scala:243:{46,71,76}
  wire [8:0]  _aFragOH1_T_1 = 9'h3 << aFrag;	// src/main/scala/tilelink/Fragmenter.scala:287:24, src/main/scala/util/package.scala:243:71
  wire [1:0]  aFragOH1 = ~(_aFragOH1_T_1[1:0]);	// src/main/scala/util/package.scala:243:{46,71,76}
  wire [1:0]  aMask = aFragOH1;	// src/main/scala/tilelink/Fragmenter.scala:291:24, src/main/scala/util/package.scala:243:46
  wire        aHasData_opdata = ~(_repeater_io_deq_bits_opcode[2]);	// src/main/scala/tilelink/Edges.scala:93:{28,37}, src/main/scala/tilelink/Fragmenter.scala:264:30
  reg  [3:0]  gennum;	// src/main/scala/tilelink/Fragmenter.scala:293:29
  wire        aFirst = gennum == 4'h0;	// src/main/scala/tilelink/Fragmenter.scala:191:29, :293:29, :294:29
  wire [3:0]  old_gennum1 = aFirst ? aOrigOH1[5:2] : gennum - 4'h1;	// src/main/scala/tilelink/Fragmenter.scala:293:29, :294:29, :295:{30,48,79}, src/main/scala/util/package.scala:243:46
  wire [3:0]  new_gennum = old_gennum1;	// src/main/scala/tilelink/Fragmenter.scala:295:30, :296:26
  wire [3:0]  aFragnum = old_gennum1;	// src/main/scala/tilelink/Fragmenter.scala:295:30, :297:24
  wire        aLast = aFragnum == 4'h0;	// src/main/scala/tilelink/Fragmenter.scala:191:29, :297:24, :298:30
  ...
  wire [16:0] nodeOut_a_bits_address =
    {_repeater_io_deq_bits_address[16:6],
     _repeater_io_deq_bits_address[5:0] | {~(old_gennum1 | ~(aOrigOH1[5:2])), 2'h0}};	// src/main/scala/diplomacy/LazyModule.scala:374:18, src/main/scala/diplomacy/Nodes.scala:1205:17, src/main/scala/tilelink/Fragmenter.scala:264:30, :295:30, :306:{49,51,88,90,111}, src/main/scala/util/package.scala:243:46
  ...
  wire [9:0]  nodeOut_a_bits_source = {nodeOut_a_bits_source_hi, aFragnum};	// src/main/scala/diplomacy/Nodes.scala:1205:17, src/main/scala/tilelink/Fragmenter.scala:297:24, :307:33
  ...
  wire [3:0]  nodeOut_a_bits_mask = _repeater_io_full ? 4'hF : nodeIn_a_bits_mask;	// src/main/scala/diplomacy/Nodes.scala:1205:17, :1214:17, src/main/scala/tilelink/Fragmenter.scala:264:30, :314:53, :315:31
  always @(posedge clock) begin
    automatic logic _T_7;	// src/main/scala/chisel3/util/Decoupled.scala:52:35
    automatic logic _GEN;	// src/main/scala/tilelink/Fragmenter.scala:192:24, :210:27, :212:25, :213:19
    _T_7 = nodeOut_d_ready & nodeOut_d_valid;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/diplomacy/Nodes.scala:1205:17
    _GEN = _T_7 & dFirst;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/tilelink/Fragmenter.scala:192:24, :195:29, :210:27, :212:25, :213:19
    if (reset) begin
      acknum <= 4'h0;	// src/main/scala/tilelink/Fragmenter.scala:191:29
      dToggle <= 1'h0;	// src/main/scala/tilelink/Fragmenter.scala:193:30
      gennum <= 4'h0;	// src/main/scala/tilelink/Fragmenter.scala:191:29, :293:29
    end
    else begin
      if (_T_7) begin	// src/main/scala/chisel3/util/Decoupled.scala:52:35
        if (dFirst)	// src/main/scala/tilelink/Fragmenter.scala:195:29
          ...
          acknum <= acknum - 4'h1;	// src/main/scala/tilelink/Fragmenter.scala:191:29, :211:55
      end
      if (_GEN)	// src/main/scala/tilelink/Fragmenter.scala:192:24, :210:27, :212:25, :213:19
        dToggle <= nodeOut_d_bits_source[4];	// src/main/scala/diplomacy/Nodes.scala:1205:17, src/main/scala/tilelink/Fragmenter.scala:193:30, :214:41
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// src/main/scala/tilelink/Fragmenter.scala:314:16
      if (~reset & ~(~_repeater_io_full | (&_repeater_io_deq_bits_mask))) begin	// src/main/scala/tilelink/Fragmenter.scala:264:30, :311:17, :314:{16,35,53}
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        acknum = _RANDOM[/*Zero width*/ 1'b0][3:0];	// src/main/scala/tilelink/Fragmenter.scala:191:29
        dOrig = _RANDOM[/*Zero width*/ 1'b0][6:4];	// src/main/scala/tilelink/Fragmenter.scala:191:29, :192:24
        dToggle = _RANDOM[/*Zero width*/ 1'b0][7];	// src/main/scala/tilelink/Fragmenter.scala:191:29, :193:30
        gennum = _RANDOM[/*Zero width*/ 1'b0][11:8];	// src/main/scala/tilelink/Fragmenter.scala:191:29, :293:29
        aToggle_r = _RANDOM[/*Zero width*/ 1'b0][12];	// src/main/scala/tilelink/Fragmenter.scala:191:29, :299:54
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Repeater_9 repeater (	// src/main/scala/tilelink/Fragmenter.scala:264:30
    .clock               (clock),
    .reset               (reset),
    .io_repeat           (|aFragnum),	// src/main/scala/tilelink/Fragmenter.scala:297:24, :304:53
