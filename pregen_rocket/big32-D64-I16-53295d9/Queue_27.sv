...
module Queue_27(
  ...
  reg  [2:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  always @(posedge clock) begin
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:281:27
      ram <= {io_enq_bits_resp, io_enq_bits_id};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    if (reset)
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = _RANDOM[/*Zero width*/ 1'b0][3:1];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  assign io_deq_bits_resp = empty ? io_enq_bits_resp : ram[2:1];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
endmodule
