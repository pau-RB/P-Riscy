...
module Queue_22(
  ...
  input         io_enq_bits_user_amba_prot_bufferable,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
                io_enq_bits_user_amba_prot_modifiable,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
                io_enq_bits_user_amba_prot_readalloc,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
                io_enq_bits_user_amba_prot_writealloc,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
                io_enq_bits_user_amba_prot_privileged,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
                io_enq_bits_user_amba_prot_secure,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
                io_enq_bits_user_amba_prot_fetch,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  output        io_deq_bits_user_amba_prot_bufferable,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
                io_deq_bits_user_amba_prot_modifiable,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
                io_deq_bits_user_amba_prot_readalloc,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
                io_deq_bits_user_amba_prot_writealloc,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
                io_deq_bits_user_amba_prot_privileged,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
                io_deq_bits_user_amba_prot_secure,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
                io_deq_bits_user_amba_prot_fetch,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  wire [89:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (do_enq != do_deq)	// src/main/scala/chisel3/util/Decoupled.scala:281:27, :282:27, :294:15
  ...
  ram_combMem_15 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_data
      ({io_enq_bits_corrupt,
        ...
        io_enq_bits_size,
        io_enq_bits_param,
        io_enq_bits_opcode}),	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[13:10];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_address = _ram_ext_R0_data[45:14];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_user_amba_prot_bufferable = _ram_ext_R0_data[46];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_user_amba_prot_modifiable = _ram_ext_R0_data[47];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_user_amba_prot_readalloc = _ram_ext_R0_data[48];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_user_amba_prot_writealloc = _ram_ext_R0_data[49];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_user_amba_prot_privileged = _ram_ext_R0_data[50];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_user_amba_prot_secure = _ram_ext_R0_data[51];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_user_amba_prot_fetch = _ram_ext_R0_data[52];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_mask = _ram_ext_R0_data[56:53];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_data = _ram_ext_R0_data[88:57];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_corrupt = _ram_ext_R0_data[89];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
