...
module AsyncQueueSink_2(
  input        clock,
               reset,
               io_async_mem_0_resumereq,	// src/main/scala/util/AsyncQueue.scala:135:14
  ...
  assign ridx_incremented = source_ready & ridx_ridx_bin + _io_deq_valid_output;	// src/main/scala/util/AsyncQueue.scala:51:27, :52:25, :53:{23,43}, :143:30, :162:29
  ...
  wire [1:0]  io_deq_bits_deq_bits_reg_io_d_lo_hi =
    {io_async_mem_0_hasel, io_async_mem_0_hamask_0};	// src/main/scala/util/SynchronizerReg.scala:209:24
  wire [2:0]  io_deq_bits_deq_bits_reg_io_d_lo =
    {io_deq_bits_deq_bits_reg_io_d_lo_hi, io_async_mem_0_hrmask_0};	// src/main/scala/util/SynchronizerReg.scala:209:24
  wire [10:0] io_deq_bits_deq_bits_reg_io_d_hi_hi =
    {io_async_mem_0_resumereq, io_async_mem_0_hartsel};	// src/main/scala/util/SynchronizerReg.scala:209:24
  wire [11:0] io_deq_bits_deq_bits_reg_io_d_hi =
    {io_deq_bits_deq_bits_reg_io_d_hi_hi, io_async_mem_0_ackhavereset};	// src/main/scala/util/SynchronizerReg.scala:209:24
  ...
  assign io_deq_bits_resumereq = _io_deq_bits_deq_bits_reg_io_q[14];	// src/main/scala/util/SynchronizerReg.scala:207:25, :211:26
  assign io_deq_bits_hartsel = _io_deq_bits_deq_bits_reg_io_q[13:4];	// src/main/scala/util/SynchronizerReg.scala:207:25, :211:26
  assign io_deq_bits_ackhavereset = _io_deq_bits_deq_bits_reg_io_q[3];	// src/main/scala/util/SynchronizerReg.scala:207:25, :211:26
  assign io_deq_bits_hrmask_0 = _io_deq_bits_deq_bits_reg_io_q[0];	// src/main/scala/util/SynchronizerReg.scala:207:25, :211:26
