...
module AXI4Fragmenter_1(
  ...
  wire [31:0]      nodeOut_ar_bits_addr = in_ar_bits_addr;	// src/main/scala/amba/axi4/Fragmenter.scala:62:23, src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  wire [31:0]      inc_addr = addr + {16'h0, 16'h1 << irr_bits_size};	// src/main/scala/amba/axi4/Fragmenter.scala:69:23, :104:{29,38}, src/main/scala/chisel3/util/Decoupled.scala:415:19
  ...
  assign in_ar_bits_addr =
    ~{_out_bits_addr_T[31:2], _out_bits_addr_T[1:0] | ~(_out_bits_addr_T_2[1:0])};	// src/main/scala/amba/axi4/Fragmenter.scala:62:23, :126:{26,28,34}, src/main/scala/util/package.scala:243:{46,71,76}
  ...
  wire [31:0]      nodeOut_aw_bits_addr = in_aw_bits_addr;	// src/main/scala/amba/axi4/Fragmenter.scala:62:23, src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  wire [31:0]      inc_addr_1 = addr_1 + {16'h0, 16'h1 << irr_1_bits_size};	// src/main/scala/amba/axi4/Fragmenter.scala:69:23, :104:{29,38}, src/main/scala/chisel3/util/Decoupled.scala:415:19
  ...
  assign in_aw_bits_addr =
    ~{_out_bits_addr_T_7[31:2], _out_bits_addr_T_7[1:0] | ~(_out_bits_addr_T_9[1:0])};	// src/main/scala/amba/axi4/Fragmenter.scala:62:23, :126:{26,28,34}, src/main/scala/util/package.scala:243:{46,71,76}
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        error_2 = _RANDOM[2'h3][1:0];	// src/main/scala/amba/axi4/Fragmenter.scala:207:26
        error_3 = _RANDOM[2'h3][3:2];	// src/main/scala/amba/axi4/Fragmenter.scala:207:26
        error_4 = _RANDOM[2'h3][5:4];	// src/main/scala/amba/axi4/Fragmenter.scala:207:26
        error_5 = _RANDOM[2'h3][7:6];	// src/main/scala/amba/axi4/Fragmenter.scala:207:26
        error_6 = _RANDOM[2'h3][9:8];	// src/main/scala/amba/axi4/Fragmenter.scala:207:26
        error_7 = _RANDOM[2'h3][11:10];	// src/main/scala/amba/axi4/Fragmenter.scala:207:26
        error_8 = _RANDOM[2'h3][13:12];	// src/main/scala/amba/axi4/Fragmenter.scala:207:26
        error_9 = _RANDOM[2'h3][15:14];	// src/main/scala/amba/axi4/Fragmenter.scala:207:26
        error_10 = _RANDOM[2'h3][17:16];	// src/main/scala/amba/axi4/Fragmenter.scala:207:26
        error_11 = _RANDOM[2'h3][19:18];	// src/main/scala/amba/axi4/Fragmenter.scala:207:26
        error_12 = _RANDOM[2'h3][21:20];	// src/main/scala/amba/axi4/Fragmenter.scala:207:26
        error_13 = _RANDOM[2'h3][23:22];	// src/main/scala/amba/axi4/Fragmenter.scala:207:26
        error_14 = _RANDOM[2'h3][25:24];	// src/main/scala/amba/axi4/Fragmenter.scala:207:26
        error_15 = _RANDOM[2'h3][27:26];	// src/main/scala/amba/axi4/Fragmenter.scala:207:26
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_91 deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock             (clock),
    .reset             (reset),
  ...
  Queue_91 deq_q_1 (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock             (clock),
    .reset             (reset),
