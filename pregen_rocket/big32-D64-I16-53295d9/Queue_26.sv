...
module Queue_26(
  ...
  reg  [67:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  always @(posedge clock) begin
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:281:27
      ram <= {io_enq_bits_last, io_enq_bits_resp, io_enq_bits_data, io_enq_bits_id};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    if (reset)
      maybe_full <= 1'h0;	// src/main/scala/chisel3/util/Decoupled.scala:277:27, :327:32
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][4:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  assign io_deq_bits_data = empty ? io_enq_bits_data : ram[64:1];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_resp = empty ? io_enq_bits_resp : ram[66:65];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_last = empty ? io_enq_bits_last : ram[67];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
endmodule
