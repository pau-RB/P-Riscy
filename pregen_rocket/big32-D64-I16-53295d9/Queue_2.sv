...
module Queue_2(
  ...
  wire [5:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  ram_combMem ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_resp, io_enq_bits_id}),	// src/main/scala/chisel3/util/Decoupled.scala:274:95
