...
module TLAtomicAutomata_1(
  ...
  wire        readys_0 = 1'h1;	// src/main/scala/tilelink/Arbiter.scala:68:27, src/main/scala/tilelink/AtomicAutomata.scala:90:45
  ...
  wire [3:0]  source_i_bits_mask = nodeIn_a_bits_mask;	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/AtomicAutomata.scala:150:28
  wire [31:0] source_i_bits_data = nodeIn_a_bits_data;	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/AtomicAutomata.scala:150:28
  ...
  reg  [3:0]  cam_a_0_bits_mask;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24
  reg  [31:0] cam_a_0_bits_data;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24
  reg         cam_a_0_bits_corrupt;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24
  reg         cam_a_0_fifoId;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24
  reg  [3:0]  cam_a_0_lut;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24
  reg  [31:0] cam_d_0_data;	// src/main/scala/tilelink/AtomicAutomata.scala:80:24
  ...
  wire        _a_canArithmetic_T_3 = nodeIn_a_bits_size < 4'h3;	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/diplomacy/Parameters.scala:92:38
  wire [3:0]  _GEN =
    {nodeIn_a_bits_address[27],
     nodeIn_a_bits_address[25],
     nodeIn_a_bits_address[16],
     ~(nodeIn_a_bits_address[13])};	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/diplomacy/Parameters.scala:137:{31,41}
  wire        a_canLogical = _a_canArithmetic_T_3 & _GEN == 4'h0;	// src/main/scala/diplomacy/Parameters.scala:92:38, :137:{41,59}, src/main/scala/tilelink/AtomicAutomata.scala:90:45, src/main/scala/tilelink/Bundles.scala:259:74, src/main/scala/tilelink/Parameters.scala:671:54
  wire        a_canArithmetic = _a_canArithmetic_T_3 & _GEN == 4'h0;	// src/main/scala/diplomacy/Parameters.scala:92:38, :137:{41,59}, src/main/scala/tilelink/AtomicAutomata.scala:91:45, src/main/scala/tilelink/Bundles.scala:259:74, src/main/scala/tilelink/Parameters.scala:671:54
  ...
  wire        a_cam_busy = cam_abusy_0 & ~cam_a_0_fifoId;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :84:57, :107:{60,96}
  ...
  wire [1:0]  logic_out_lo_lo_lo_lo = {_logic_out_T_2[0], _logic_out_T[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [1:0]  logic_out_lo_lo_lo_hi = {_logic_out_T_6[0], _logic_out_T_4[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [3:0]  logic_out_lo_lo_lo = {logic_out_lo_lo_lo_hi, logic_out_lo_lo_lo_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  wire [1:0]  logic_out_lo_lo_hi_lo = {_logic_out_T_10[0], _logic_out_T_8[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [1:0]  logic_out_lo_lo_hi_hi = {_logic_out_T_14[0], _logic_out_T_12[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [3:0]  logic_out_lo_lo_hi = {logic_out_lo_lo_hi_hi, logic_out_lo_lo_hi_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  wire [7:0]  logic_out_lo_lo = {logic_out_lo_lo_hi, logic_out_lo_lo_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  wire [1:0]  logic_out_lo_hi_lo_lo = {_logic_out_T_18[0], _logic_out_T_16[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [1:0]  logic_out_lo_hi_lo_hi = {_logic_out_T_22[0], _logic_out_T_20[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [3:0]  logic_out_lo_hi_lo = {logic_out_lo_hi_lo_hi, logic_out_lo_hi_lo_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  wire [1:0]  logic_out_lo_hi_hi_lo = {_logic_out_T_26[0], _logic_out_T_24[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [1:0]  logic_out_lo_hi_hi_hi = {_logic_out_T_30[0], _logic_out_T_28[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [3:0]  logic_out_lo_hi_hi = {logic_out_lo_hi_hi_hi, logic_out_lo_hi_hi_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  wire [7:0]  logic_out_lo_hi = {logic_out_lo_hi_hi, logic_out_lo_hi_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  wire [15:0] logic_out_lo = {logic_out_lo_hi, logic_out_lo_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  wire [1:0]  logic_out_hi_lo_lo_lo = {_logic_out_T_34[0], _logic_out_T_32[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [1:0]  logic_out_hi_lo_lo_hi = {_logic_out_T_38[0], _logic_out_T_36[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [3:0]  logic_out_hi_lo_lo = {logic_out_hi_lo_lo_hi, logic_out_hi_lo_lo_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  wire [1:0]  logic_out_hi_lo_hi_lo = {_logic_out_T_42[0], _logic_out_T_40[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [1:0]  logic_out_hi_lo_hi_hi = {_logic_out_T_46[0], _logic_out_T_44[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [3:0]  logic_out_hi_lo_hi = {logic_out_hi_lo_hi_hi, logic_out_hi_lo_hi_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  wire [7:0]  logic_out_hi_lo = {logic_out_hi_lo_hi, logic_out_hi_lo_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  wire [1:0]  logic_out_hi_hi_lo_lo = {_logic_out_T_50[0], _logic_out_T_48[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [1:0]  logic_out_hi_hi_lo_hi = {_logic_out_T_54[0], _logic_out_T_52[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [3:0]  logic_out_hi_hi_lo = {logic_out_hi_hi_lo_hi, logic_out_hi_hi_lo_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  wire [1:0]  logic_out_hi_hi_hi_lo = {_logic_out_T_58[0], _logic_out_T_56[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [1:0]  logic_out_hi_hi_hi_hi = {_logic_out_T_62[0], _logic_out_T_60[0]};	// src/main/scala/tilelink/AtomicAutomata.scala:116:{28,57}
  wire [3:0]  logic_out_hi_hi_hi = {logic_out_hi_hi_hi_hi, logic_out_hi_hi_hi_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  wire [7:0]  logic_out_hi_hi = {logic_out_hi_hi_hi, logic_out_hi_hi_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  wire [15:0] logic_out_hi = {logic_out_hi_hi, logic_out_hi_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  wire [31:0] logic_out = {logic_out_hi, logic_out_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:116:28
  ...
  wire [3:0]  _signSel_T = ~cam_a_0_bits_mask;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :123:25
  wire [3:0]  signSel = ~{_signSel_T[3], _signSel_T[2:0] | cam_a_0_bits_mask[3:1]};	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :123:{23,25,31,39}
  wire [1:0]  signbits_a_lo = {cam_a_0_bits_data[15], cam_a_0_bits_data[7]};	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :115:63, :124:29
  wire [1:0]  signbits_a_hi = {cam_a_0_bits_data[31], cam_a_0_bits_data[23]};	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :115:63, :124:29
  wire [3:0]  signbits_a = {signbits_a_hi, signbits_a_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:124:29
  wire [1:0]  signbits_d_lo = {cam_d_0_data[15], cam_d_0_data[7]};	// src/main/scala/tilelink/AtomicAutomata.scala:80:24, :115:73, :125:29
  wire [1:0]  signbits_d_hi = {cam_d_0_data[31], cam_d_0_data[23]};	// src/main/scala/tilelink/AtomicAutomata.scala:80:24, :115:73, :125:29
  wire [3:0]  signbits_d = {signbits_d_hi, signbits_d_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:125:29
  wire [3:0]  signbit_a = {signbits_a[2:0] & signSel[2:0], 1'h0};	// src/main/scala/tilelink/AtomicAutomata.scala:77:23, :123:23, :124:29, :127:{38,54}
  wire [3:0]  signbit_d = {signbits_d[2:0] & signSel[2:0], 1'h0};	// src/main/scala/tilelink/AtomicAutomata.scala:77:23, :123:23, :125:29, :128:{38,54}
  wire [3:0]  _signext_a_T_2 = signbit_a | {signbit_a[2:0], 1'h0};	// src/main/scala/tilelink/AtomicAutomata.scala:77:23, :127:54, src/main/scala/util/package.scala:253:{43,53}
  wire [3:0]  _signext_a_T_6 = _signext_a_T_2 | {_signext_a_T_2[1:0], 2'h0};	// src/main/scala/tilelink/AtomicAutomata.scala:78:50, src/main/scala/util/package.scala:253:{43,53}
  wire [15:0] signext_a_lo = {{8{_signext_a_T_6[1]}}, {8{_signext_a_T_6[0]}}};	// src/main/scala/tilelink/AtomicAutomata.scala:129:40, src/main/scala/util/package.scala:253:43
  wire [15:0] signext_a_hi = {{8{_signext_a_T_6[3]}}, {8{_signext_a_T_6[2]}}};	// src/main/scala/tilelink/AtomicAutomata.scala:129:40, src/main/scala/util/package.scala:253:43
  wire [31:0] signext_a = {signext_a_hi, signext_a_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:129:40
  wire [3:0]  _signext_d_T_2 = signbit_d | {signbit_d[2:0], 1'h0};	// src/main/scala/tilelink/AtomicAutomata.scala:77:23, :128:54, src/main/scala/util/package.scala:253:{43,53}
  wire [3:0]  _signext_d_T_6 = _signext_d_T_2 | {_signext_d_T_2[1:0], 2'h0};	// src/main/scala/tilelink/AtomicAutomata.scala:78:50, src/main/scala/util/package.scala:253:{43,53}
  wire [15:0] signext_d_lo = {{8{_signext_d_T_6[1]}}, {8{_signext_d_T_6[0]}}};	// src/main/scala/tilelink/AtomicAutomata.scala:130:40, src/main/scala/util/package.scala:253:43
  wire [15:0] signext_d_hi = {{8{_signext_d_T_6[3]}}, {8{_signext_d_T_6[2]}}};	// src/main/scala/tilelink/AtomicAutomata.scala:130:40, src/main/scala/util/package.scala:253:43
  wire [31:0] signext_d = {signext_d_hi, signext_d_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:130:40
  wire [15:0] wide_mask_lo = {{8{cam_a_0_bits_mask[1]}}, {8{cam_a_0_bits_mask[0]}}};	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :132:40
  wire [15:0] wide_mask_hi = {{8{cam_a_0_bits_mask[3]}}, {8{cam_a_0_bits_mask[2]}}};	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :132:40
  wire [31:0] wide_mask = {wide_mask_hi, wide_mask_lo};	// src/main/scala/tilelink/AtomicAutomata.scala:132:40
  wire [31:0] a_a_ext = cam_a_0_bits_data & wide_mask | signext_a;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :129:40, :132:40, :133:{28,41}
  wire [31:0] a_d_ext = cam_d_0_data & wide_mask | signext_d;	// src/main/scala/tilelink/AtomicAutomata.scala:80:24, :130:40, :132:40, :134:{28,41}
  wire [31:0] a_d_inv = {32{~adder}} ^ a_d_ext;	// src/main/scala/tilelink/AtomicAutomata.scala:121:39, :134:41, :135:26
  wire [31:0] adder_out = a_a_ext + a_d_inv;	// src/main/scala/tilelink/AtomicAutomata.scala:133:41, :135:26, :136:33
  wire        a_bigger_uneq = unsigned_0 == a_a_ext[31];	// src/main/scala/tilelink/AtomicAutomata.scala:119:42, :133:41, :138:{38,49}
  wire        a_bigger = a_a_ext[31] == a_d_ext[31] ? ~(adder_out[31]) : a_bigger_uneq;	// src/main/scala/tilelink/AtomicAutomata.scala:133:41, :134:41, :136:33, :138:{38,49}, :139:{27,39,50,55,65}
  wire        pick_a = take_max == a_bigger;	// src/main/scala/tilelink/AtomicAutomata.scala:120:42, :139:27, :140:31
  wire [31:0] arith_out = adder ? adder_out : pick_a ? cam_a_0_bits_data : cam_d_0_data;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :80:24, :121:39, :136:33, :140:31, :141:{28,50}
  wire [31:0] amo_data = cam_a_0_bits_opcode[0] ? logic_out : arith_out;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :116:28, :141:28, :147:{14,34}
  wire [31:0] source_c_bits_a_data = amo_data;	// src/main/scala/tilelink/AtomicAutomata.scala:147:14, src/main/scala/tilelink/Edges.scala:473:17
  ...
  wire        nodeIn_a_ready = source_i_ready & a_allow;	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/AtomicAutomata.scala:150:28, :151:35, :152:38
  ...
  wire [3:0]  source_c_bits_a_mask;	// src/main/scala/tilelink/Edges.scala:473:17
  ...
  wire        source_c_bits_legal =
    ...
    & ({cam_a_0_bits_address[27],
       ...
       | {cam_a_0_bits_address[27],
          ~(cam_a_0_bits_address[25]),
          cam_a_0_bits_address[16]} == 3'h0 | cam_a_0_bits_address[27]);	// src/main/scala/diplomacy/Parameters.scala:92:38, :137:{31,41,59}, src/main/scala/tilelink/AtomicAutomata.scala:79:24, src/main/scala/tilelink/Bundles.scala:259:74, src/main/scala/tilelink/Parameters.scala:671:54, :672:42, :673:26
  ...
  wire [3:0]  source_c_bits_mask = source_c_bits_a_mask;	// src/main/scala/tilelink/AtomicAutomata.scala:161:28, src/main/scala/tilelink/Edges.scala:473:17
  wire [31:0] source_c_bits_data = source_c_bits_a_data;	// src/main/scala/tilelink/AtomicAutomata.scala:161:28, src/main/scala/tilelink/Edges.scala:473:17
  ...
  wire        source_c_bits_a_mask_sizeOH_shiftAmount = cam_a_0_bits_size[0];	// src/main/scala/chisel3/util/OneHot.scala:64:49, src/main/scala/tilelink/AtomicAutomata.scala:79:24
  wire [1:0]  source_c_bits_a_mask_sizeOH =
    {source_c_bits_a_mask_sizeOH_shiftAmount, 1'h1};	// src/main/scala/chisel3/util/OneHot.scala:64:49, src/main/scala/tilelink/AtomicAutomata.scala:90:45, src/main/scala/util/Misc.scala:202:81
  wire        source_c_bits_a_mask_size = source_c_bits_a_mask_sizeOH[1];	// src/main/scala/util/Misc.scala:202:81, :209:26
  wire        source_c_bits_a_mask_bit = cam_a_0_bits_address[1];	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, src/main/scala/util/Misc.scala:210:26
  ...
  wire        source_c_bits_a_mask_acc =
    (|(cam_a_0_bits_size[3:1])) | source_c_bits_a_mask_size & source_c_bits_a_mask_eq;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, src/main/scala/util/Misc.scala:206:21, :209:26, :214:27, :215:{29,38}
  wire        source_c_bits_a_mask_acc_1 =
    (|(cam_a_0_bits_size[3:1])) | source_c_bits_a_mask_size & source_c_bits_a_mask_eq_1;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, src/main/scala/util/Misc.scala:206:21, :209:26, :214:27, :215:{29,38}
  wire        source_c_bits_a_mask_size_1 = source_c_bits_a_mask_sizeOH[0];	// src/main/scala/util/Misc.scala:202:81, :209:26
  wire        source_c_bits_a_mask_bit_1 = cam_a_0_bits_address[0];	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, src/main/scala/util/Misc.scala:210:26
  ...
  wire [1:0]  source_c_bits_a_mask_lo =
    {source_c_bits_a_mask_acc_3, source_c_bits_a_mask_acc_2};	// src/main/scala/util/Misc.scala:215:29, :222:10
  wire [1:0]  source_c_bits_a_mask_hi =
    {source_c_bits_a_mask_acc_5, source_c_bits_a_mask_acc_4};	// src/main/scala/util/Misc.scala:215:29, :222:10
  ...
  wire [26:0] _decode_T_1 = 27'hFFF << nodeIn_a_bits_size;	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/util/package.scala:243:71
  wire [9:0]  decode = ~(_decode_T_1[11:2]);	// src/main/scala/tilelink/Edges.scala:221:59, src/main/scala/util/package.scala:243:{46,71,76}
  ...
  wire        idle = beatsLeft == 10'h0;	// src/main/scala/tilelink/Arbiter.scala:60:30, :61:28, :84:44
  ...
  wire [9:0]  maskedBeats_1 = winner_1 & opdata ? decode : 10'h0;	// src/main/scala/tilelink/Arbiter.scala:71:27, :82:69, :84:44, src/main/scala/tilelink/Edges.scala:93:28, :221:59, :222:14
  wire [9:0]  initBeats = maskedBeats_1;	// src/main/scala/tilelink/Arbiter.scala:82:69, :84:44
  ...
  wire [31:0] nodeOut_a_bits_data =
    (muxState_0 ? source_c_bits_data : 32'h0) | (muxState_1 ? source_i_bits_data : 32'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/diplomacy/Nodes.scala:1205:17, src/main/scala/tilelink/Arbiter.scala:89:25, src/main/scala/tilelink/AtomicAutomata.scala:150:28, :161:28, src/main/scala/tilelink/Bundles.scala:259:74
  wire [3:0]  nodeOut_a_bits_mask =
    (muxState_0 ? source_c_bits_mask : 4'h0) | (muxState_1 ? source_i_bits_mask : 4'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/diplomacy/Nodes.scala:1205:17, src/main/scala/tilelink/Arbiter.scala:89:25, src/main/scala/tilelink/AtomicAutomata.scala:150:28, :161:28, src/main/scala/tilelink/Bundles.scala:259:74
  wire [27:0] nodeOut_a_bits_address =
  ...
  wire [4:0]  nodeOut_a_bits_source =
    (muxState_0 ? source_c_bits_source : 5'h0)
    | (muxState_1 ? source_i_bits_source : 5'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/diplomacy/Nodes.scala:1205:17, src/main/scala/tilelink/Arbiter.scala:89:25, src/main/scala/tilelink/AtomicAutomata.scala:150:28, :161:28, src/main/scala/tilelink/Bundles.scala:259:74
  wire [3:0]  nodeOut_a_bits_size =
  ...
  wire [2:0]  nodeOut_a_bits_param = muxState_1 ? source_i_bits_param : 3'h0;	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/diplomacy/Nodes.scala:1205:17, src/main/scala/tilelink/Arbiter.scala:89:25, src/main/scala/tilelink/AtomicAutomata.scala:150:28
  wire [2:0]  nodeOut_a_bits_opcode = muxState_1 ? source_i_bits_opcode : 3'h0;	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/diplomacy/Nodes.scala:1205:17, src/main/scala/tilelink/Arbiter.scala:89:25, src/main/scala/tilelink/AtomicAutomata.scala:150:28
  wire        nodeOut_d_ready;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire        _T_23 = nodeOut_d_ready & nodeOut_d_valid;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  wire [9:0]  d_first_beats1_decode = ~(_d_first_beats1_decode_T_1[11:2]);	// src/main/scala/tilelink/Edges.scala:221:59, src/main/scala/util/package.scala:243:{46,71,76}
  ...
  wire [9:0]  d_first_beats1 = d_first_beats1_opdata ? d_first_beats1_decode : 10'h0;	// src/main/scala/tilelink/Arbiter.scala:84:44, src/main/scala/tilelink/Edges.scala:107:36, :221:59, :222:14
  reg  [9:0]  d_first_counter;	// src/main/scala/tilelink/Edges.scala:230:27
  wire [9:0]  d_first_counter1 = d_first_counter - 10'h1;	// src/main/scala/tilelink/Edges.scala:230:27, :231:28
  wire        d_first = d_first_counter == 10'h0;	// src/main/scala/tilelink/Arbiter.scala:84:44, src/main/scala/tilelink/Edges.scala:230:27, :232:25
  wire        d_first_last = d_first_counter == 10'h1 | d_first_beats1 == 10'h0;	// src/main/scala/tilelink/Arbiter.scala:84:44, src/main/scala/tilelink/Edges.scala:222:14, :230:27, :233:{25,33,43}
  wire        d_first_done = d_first_last & _T_23;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/tilelink/Edges.scala:233:33, :234:22
  wire [9:0]  d_first_count = d_first_beats1 & ~d_first_counter1;	// src/main/scala/tilelink/Edges.scala:222:14, :231:28, :235:{25,27}
  ...
  wire        nodeIn_d_valid = nodeOut_d_valid & ~d_drop;	// src/main/scala/diplomacy/Nodes.scala:1205:17, :1214:17, src/main/scala/tilelink/AtomicAutomata.scala:234:40, :237:{35,38}
  ...
  wire [2:0]  nodeIn_d_bits_opcode = d_replace ? 3'h1 : nodeOut_d_bits_opcode;	// src/main/scala/diplomacy/Nodes.scala:1205:17, :1214:17, src/main/scala/tilelink/AtomicAutomata.scala:235:42, :240:19, :241:26, :242:28
  wire [31:0] nodeIn_d_bits_data = d_replace ? cam_d_0_data : nodeOut_d_bits_data;	// src/main/scala/diplomacy/Nodes.scala:1205:17, :1214:17, src/main/scala/tilelink/AtomicAutomata.scala:80:24, :235:42, :240:19, :241:26, :243:26
  ...
  wire        nodeIn_d_bits_denied = d_replace & cam_d_0_denied | nodeOut_d_bits_denied;	// src/main/scala/diplomacy/Nodes.scala:1205:17, :1214:17, src/main/scala/tilelink/AtomicAutomata.scala:80:24, :235:42, :240:19, :241:26, :245:29
  always @(posedge clock) begin
    automatic logic _GEN_0;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :176:48, :178:23, :179:24
    automatic logic _T_24;	// src/main/scala/tilelink/AtomicAutomata.scala:218:26
    _GEN_0 = source_i_ready & source_i_valid & ~a_isSupported & a_cam_sel_free_0;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :94:32, :112:82, :150:28, :155:15, :176:48, :178:23, :179:24
    _T_24 = _T_23 & d_first;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/tilelink/AtomicAutomata.scala:218:26, src/main/scala/tilelink/Edges.scala:232:25
    if (reset) begin
      cam_s_0_state <= 2'h0;	// src/main/scala/tilelink/AtomicAutomata.scala:78:{28,50}
      beatsLeft <= 10'h0;	// src/main/scala/tilelink/Arbiter.scala:60:30, :84:44
      ...
      d_first_counter <= 10'h0;	// src/main/scala/tilelink/Arbiter.scala:84:44, src/main/scala/tilelink/Edges.scala:230:27
    end
    else begin
      if (_T_24 & d_cam_sel_0)	// src/main/scala/tilelink/AtomicAutomata.scala:196:30, :213:85, :218:{26,38}, :227:23, :229:23
      ...
      else if (_GEN_0)	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :176:48, :178:23, :179:24
      ...
      if (latch)	// src/main/scala/tilelink/Arbiter.scala:62:24
        ...
        beatsLeft <= beatsLeft - {9'h0, nodeOut_a_ready & nodeOut_a_valid};	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/diplomacy/Nodes.scala:1205:17, src/main/scala/tilelink/Arbiter.scala:60:30, :85:52
    ...
    if (_GEN_0) begin	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :176:48, :178:23, :179:24
      automatic logic [3:0][3:0] _GEN_1 = '{4'hC, 4'h8, 4'hE, 4'h6};	// src/main/scala/chisel3/util/Mux.scala:77:13
      ...
      cam_a_0_lut <= _GEN_1[nodeIn_a_bits_param[1:0]];	// src/main/scala/chisel3/util/Mux.scala:77:13, src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/AtomicAutomata.scala:79:24, :181:52
    end
    cam_a_0_fifoId <= ~_GEN_0 & cam_a_0_fifoId;	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :176:48, :178:23, :179:24
    if (_T_24 & d_cam_sel_0 & d_ackd) begin	// src/main/scala/tilelink/AtomicAutomata.scala:80:24, :213:85, :215:40, :218:{26,38}, :220:33, :221:22
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// src/main/scala/tilelink/Arbiter.scala:77:13
      ...
      if (~reset & ~(~_nodeOut_a_valid_T | winner_0 | winner_1)) begin	// src/main/scala/tilelink/Arbiter.scala:71:27, :79:{14,15,31,36}
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_mask = _RANDOM[3'h1][16:13];	// src/main/scala/tilelink/AtomicAutomata.scala:79:24
        cam_a_0_bits_data = {_RANDOM[3'h1][31:17], _RANDOM[3'h2][16:0]};	// src/main/scala/tilelink/AtomicAutomata.scala:79:24
        cam_a_0_bits_corrupt = _RANDOM[3'h2][17];	// src/main/scala/tilelink/AtomicAutomata.scala:79:24
        cam_a_0_fifoId = _RANDOM[3'h2][18];	// src/main/scala/tilelink/AtomicAutomata.scala:79:24
        cam_a_0_lut = _RANDOM[3'h2][22:19];	// src/main/scala/tilelink/AtomicAutomata.scala:79:24
        cam_d_0_data = {_RANDOM[3'h2][31:23], _RANDOM[3'h3][22:0]};	// src/main/scala/tilelink/AtomicAutomata.scala:79:24, :80:24
        cam_d_0_denied = _RANDOM[3'h3][23];	// src/main/scala/tilelink/AtomicAutomata.scala:80:24
        cam_d_0_corrupt = _RANDOM[3'h3][24];	// src/main/scala/tilelink/AtomicAutomata.scala:80:24
        beatsLeft = {_RANDOM[3'h3][31:25], _RANDOM[3'h4][2:0]};	// src/main/scala/tilelink/Arbiter.scala:60:30, src/main/scala/tilelink/AtomicAutomata.scala:80:24
        state_0 = _RANDOM[3'h4][3];	// src/main/scala/tilelink/Arbiter.scala:60:30, :88:26
        state_1 = _RANDOM[3'h4][4];	// src/main/scala/tilelink/Arbiter.scala:60:30, :88:26
        d_first_counter = _RANDOM[3'h4][14:5];	// src/main/scala/tilelink/Arbiter.scala:60:30, src/main/scala/tilelink/Edges.scala:230:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
