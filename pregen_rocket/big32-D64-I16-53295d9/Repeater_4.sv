...
module Repeater_4(
  ...
  input  [30:0]  io_enq_bits_address,	// src/main/scala/util/Repeater.scala:12:14
  input  [63:0]  io_enq_bits_mask,	// src/main/scala/util/Repeater.scala:12:14
  ...
  output [30:0]  io_deq_bits_address,	// src/main/scala/util/Repeater.scala:12:14
  ...
  output [63:0]  io_deq_bits_mask,	// src/main/scala/util/Repeater.scala:12:14
  ...
  reg  [30:0]  saved_address;	// src/main/scala/util/Repeater.scala:20:18
  ...
  reg  [63:0]  saved_mask;	// src/main/scala/util/Repeater.scala:20:18
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_size = _RANDOM[5'h0][10:7];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_source = _RANDOM[5'h0][15:11];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_address = {_RANDOM[5'h0][31:16], _RANDOM[5'h1][14:0]};	// src/main/scala/util/Repeater.scala:19:21, :20:18
        ...
        saved_mask = {_RANDOM[5'h1][31:22], _RANDOM[5'h2], _RANDOM[5'h3][21:0]};	// src/main/scala/util/Repeater.scala:20:18
        saved_data =
          {_RANDOM[5'h3][31:22],
           _RANDOM[5'h4],
           _RANDOM[5'h5],
           ...
           _RANDOM[5'h11],
           _RANDOM[5'h12],
           _RANDOM[5'h13][21:0]};	// src/main/scala/util/Repeater.scala:20:18
        saved_corrupt = _RANDOM[5'h13][22];	// src/main/scala/util/Repeater.scala:20:18
      `endif // RANDOMIZE_REG_INIT
    end // initial
