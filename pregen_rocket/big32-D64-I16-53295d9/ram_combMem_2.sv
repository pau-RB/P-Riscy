...
module ram_combMem_2(	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  input  [2:0] R0_addr,
  input        R0_en,
               R0_clk,
  input  [2:0] W0_addr,
  ...
  reg [8:0] Memory[0:7];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:274:95
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Decoupled.scala:274:95
        for (logic [3:0] i = 4'h0; i < 4'h8; i += 4'h1) begin
          ...
          Memory[i[2:0]] = _RANDOM_MEM[8:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
        end	// src/main/scala/chisel3/util/Decoupled.scala:274:95
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // not def SYNTHESIS
  assign R0_data = R0_en ? Memory[R0_addr] : 9'bx;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
