...
module Queue_91(
  ...
  reg  [60:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[1'h0][31:1], _RANDOM[1'h1][29:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  assign io_deq_bits_id = empty ? io_enq_bits_id : ram[3:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_addr = empty ? io_enq_bits_addr : ram[35:4];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_len = empty ? io_enq_bits_len : ram[43:36];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_size = empty ? io_enq_bits_size : ram[46:44];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_burst = empty ? io_enq_bits_burst : ram[48:47];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_lock = empty ? io_enq_bits_lock : ram[49];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_cache = empty ? io_enq_bits_cache : ram[53:50];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_prot = empty ? io_enq_bits_prot : ram[56:54];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_qos = empty ? io_enq_bits_qos : ram[60:57];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
endmodule
