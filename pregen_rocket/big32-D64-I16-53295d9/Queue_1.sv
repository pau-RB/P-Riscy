...
module Queue_1(
  ...
  wire [36:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  ram_combMem_5 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_last, io_enq_bits_strb, io_enq_bits_data}),	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[31:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_strb = _ram_ext_R0_data[35:32];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_last = _ram_ext_R0_data[36];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
