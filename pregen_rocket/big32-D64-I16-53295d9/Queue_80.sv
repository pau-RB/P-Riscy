...
module Queue_80(
  ...
  wire [619:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  ram_combMem_18 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_data
      ({io_enq_bits_corrupt,
        576'hFFFFFFFFFFFFFFFF,
        io_enq_bits_address,
        6'h6,
        io_enq_bits_param,
        3'h6}),	// src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95
  ...
  assign io_deq_bits_mask = _ram_ext_R0_data[106:43];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_data = _ram_ext_R0_data[618:107];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_corrupt = _ram_ext_R0_data[619];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
