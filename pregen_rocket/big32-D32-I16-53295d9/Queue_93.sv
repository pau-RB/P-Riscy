...
module Queue_93(
  ...
  input  [3:0]  io_enq_bits_strb,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  output [3:0]  io_deq_bits_strb,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  reg  [36:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  always @(posedge clock) begin
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:281:27
      ram <= {io_enq_bits_last, io_enq_bits_strb, io_enq_bits_data};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    if (reset)
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[1'h0][31:1], _RANDOM[1'h1][5:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  assign io_deq_bits_data = empty ? io_enq_bits_data : ram[31:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_strb = empty ? io_enq_bits_strb : ram[35:32];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_last = empty ? io_enq_bits_last : ram[36];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
endmodule
