...
module TLError(
  ...
  wire [13:0]     nodeIn_a_bits_address = auto_in_a_bits_address;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [1:0]      da_bits_param = 2'h0;	// src/main/scala/devices/tilelink/Error.scala:25:18, src/main/scala/diplomacy/LazyModule.scala:374:18
  wire [31:0]     nodeIn_d_bits_data = 32'h0;	// src/main/scala/diplomacy/LazyModule.scala:374:18, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [31:0]     da_bits_data = 32'h0;	// src/main/scala/devices/tilelink/Error.scala:25:18, src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  wire            nodeIn_d_valid = da_valid;	// src/main/scala/devices/tilelink/Error.scala:25:18, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [2:0]      nodeIn_d_bits_opcode = da_bits_opcode;	// src/main/scala/devices/tilelink/Error.scala:25:18, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [3:0]      nodeIn_d_bits_size = da_bits_size;	// src/main/scala/devices/tilelink/Error.scala:25:18, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [4:0]      nodeIn_d_bits_source = da_bits_source;	// src/main/scala/devices/tilelink/Error.scala:25:18, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire            da_bits_corrupt_opdata;	// src/main/scala/tilelink/Edges.scala:107:36
  wire            nodeIn_d_bits_corrupt = da_bits_corrupt;	// src/main/scala/devices/tilelink/Error.scala:25:18, src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [26:0]     _a_last_beats1_decode_T_1 = 27'hFFF << _a_q_io_deq_bits_size;	// src/main/scala/chisel3/util/Decoupled.scala:376:21, src/main/scala/util/package.scala:243:71
  wire [9:0]      a_last_beats1_decode = ~(_a_last_beats1_decode_T_1[11:2]);	// src/main/scala/tilelink/Edges.scala:221:59, src/main/scala/util/package.scala:243:{46,71,76}
  ...
  wire [9:0]      a_last_beats1 = a_last_beats1_opdata ? a_last_beats1_decode : 10'h0;	// src/main/scala/tilelink/Edges.scala:93:28, :221:59, :222:14, :230:27
  reg  [9:0]      a_last_counter;	// src/main/scala/tilelink/Edges.scala:230:27
  wire [9:0]      a_last_counter1 = a_last_counter - 10'h1;	// src/main/scala/tilelink/Edges.scala:230:27, :231:28
  wire            a_last_first = a_last_counter == 10'h0;	// src/main/scala/tilelink/Edges.scala:230:27, :232:25
  wire            a_last = a_last_counter == 10'h1 | a_last_beats1 == 10'h0;	// src/main/scala/tilelink/Edges.scala:222:14, :230:27, :233:{25,33,43}
  ...
  wire [9:0]      a_last_count = a_last_beats1 & ~a_last_counter1;	// src/main/scala/tilelink/Edges.scala:222:14, :231:28, :235:{25,27}
  wire            _T = da_ready & da_valid;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/devices/tilelink/Error.scala:25:18
  wire [26:0]     _beats1_decode_T_1 = 27'hFFF << da_bits_size;	// src/main/scala/devices/tilelink/Error.scala:25:18, src/main/scala/util/package.scala:243:71
  wire [9:0]      beats1_decode = ~(_beats1_decode_T_1[11:2]);	// src/main/scala/tilelink/Edges.scala:221:59, src/main/scala/util/package.scala:243:{46,71,76}
  ...
  wire [9:0]      beats1 = beats1_opdata ? beats1_decode : 10'h0;	// src/main/scala/tilelink/Edges.scala:107:36, :221:59, :222:14, :230:27
  reg  [9:0]      counter;	// src/main/scala/tilelink/Edges.scala:230:27
  wire [9:0]      counter1 = counter - 10'h1;	// src/main/scala/tilelink/Edges.scala:230:27, :231:28
  wire            da_first = counter == 10'h0;	// src/main/scala/tilelink/Edges.scala:230:27, :232:25
  wire            da_last = counter == 10'h1 | beats1 == 10'h0;	// src/main/scala/tilelink/Edges.scala:222:14, :230:27, :233:{25,33,43}
  wire            done = da_last & _T;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/tilelink/Edges.scala:233:33, :234:22
  wire [9:0]      count = beats1 & ~counter1;	// src/main/scala/tilelink/Edges.scala:222:14, :231:28, :235:{25,27}
  ...
  always @(posedge clock) begin
    if (reset) begin
      a_last_counter <= 10'h0;	// src/main/scala/tilelink/Edges.scala:230:27
      counter <= 10'h0;	// src/main/scala/tilelink/Edges.scala:230:27
    end
    else begin
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        a_last_counter = _RANDOM[/*Zero width*/ 1'b0][10:1];	// src/main/scala/tilelink/Edges.scala:230:27
        counter = _RANDOM[/*Zero width*/ 1'b0][20:11];	// src/main/scala/tilelink/Edges.scala:230:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
