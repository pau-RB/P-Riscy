...
module Queue_4(
  ...
  wire [38:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  ram_combMem_6 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_last, io_enq_bits_resp, io_enq_bits_data, io_enq_bits_id}),	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  assign io_deq_bits_last = _ram_ext_R0_data[38];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
