...
module ram_combMem_1(	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  input  [1:0] R0_addr,
  input        R0_en,
               R0_clk,
  input  [1:0] W0_addr,
  ...
  reg [7:0] Memory[0:3];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:274:95
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Decoupled.scala:274:95
        for (logic [2:0] i = 3'h0; i < 3'h4; i += 3'h1) begin
          ...
          Memory[i[1:0]] = _RANDOM_MEM[7:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
