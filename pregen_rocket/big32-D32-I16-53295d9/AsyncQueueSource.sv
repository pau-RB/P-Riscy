...
module AsyncQueueSource(
  ...
  output [2:0]  io_async_mem_0_opcode,	// src/main/scala/util/AsyncQueue.scala:71:14
                io_async_mem_0_param,	// src/main/scala/util/AsyncQueue.scala:71:14
  ...
  output [3:0]  io_async_mem_0_mask,	// src/main/scala/util/AsyncQueue.scala:71:14
  ...
  reg  [2:0]  mem_0_param;	// src/main/scala/util/AsyncQueue.scala:80:16
  ...
  reg  [3:0]  mem_0_mask;	// src/main/scala/util/AsyncQueue.scala:80:16
  ...
  always @(posedge clock) begin
    if (_T) begin	// src/main/scala/chisel3/util/Decoupled.scala:52:35
      ...
      mem_0_param <= 3'h0;	// src/main/scala/util/AsyncQueue.scala:71:14, :80:16
      mem_0_size <= 2'h2;	// src/main/scala/util/AsyncQueue.scala:80:16
      mem_0_address <= io_enq_bits_address;	// src/main/scala/util/AsyncQueue.scala:80:16
      mem_0_mask <= 4'hF;	// src/main/scala/util/AsyncQueue.scala:71:14, :80:16
      mem_0_data <= io_enq_bits_data;	// src/main/scala/util/AsyncQueue.scala:80:16
    end
    mem_0_source <= ~_T & mem_0_source;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/util/AsyncQueue.scala:80:16, :86:{22,35}
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_param = _RANDOM[1'h0][5:3];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_size = _RANDOM[1'h0][7:6];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_source = _RANDOM[1'h0][8];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_address = _RANDOM[1'h0][17:9];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_mask = _RANDOM[1'h0][21:18];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_data = {_RANDOM[1'h0][31:22], _RANDOM[1'h1][21:0]};	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_corrupt = _RANDOM[1'h1][22];	// src/main/scala/util/AsyncQueue.scala:80:16
  ...
  assign io_async_mem_0_address = mem_0_address;	// src/main/scala/util/AsyncQueue.scala:80:16
  assign io_async_mem_0_mask = mem_0_mask;	// src/main/scala/util/AsyncQueue.scala:80:16
