...
module AXI4RAM_1(
  ...
  wire [1:0]  r_addr_lo_lo = nodeIn_ar_bits_addr[3:2];	// src/main/scala/amba/axi4/SRAM.scala:65:21, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [1:0]  r_addr_lo_hi_hi = nodeIn_ar_bits_addr[6:5];	// src/main/scala/amba/axi4/SRAM.scala:65:21, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [2:0]  r_addr_lo_hi = {r_addr_lo_hi_hi, nodeIn_ar_bits_addr[4]};	// src/main/scala/amba/axi4/SRAM.scala:65:{21,49,73}, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [4:0]  r_addr_lo = {r_addr_lo_hi, r_addr_lo_lo};	// src/main/scala/amba/axi4/SRAM.scala:65:21
  wire [1:0]  r_addr_hi_lo = nodeIn_ar_bits_addr[8:7];	// src/main/scala/amba/axi4/SRAM.scala:65:21, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [1:0]  r_addr_hi_hi_hi = nodeIn_ar_bits_addr[11:10];	// src/main/scala/amba/axi4/SRAM.scala:65:21, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [2:0]  r_addr_hi_hi = {r_addr_hi_hi_hi, nodeIn_ar_bits_addr[9]};	// src/main/scala/amba/axi4/SRAM.scala:65:{21,49,73}, src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [1:0]  w_addr_lo_lo = nodeIn_aw_bits_addr[3:2];	// src/main/scala/amba/axi4/SRAM.scala:66:21, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [1:0]  w_addr_lo_hi_hi = nodeIn_aw_bits_addr[6:5];	// src/main/scala/amba/axi4/SRAM.scala:66:21, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [2:0]  w_addr_lo_hi = {w_addr_lo_hi_hi, nodeIn_aw_bits_addr[4]};	// src/main/scala/amba/axi4/SRAM.scala:66:{21,49,73}, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [4:0]  w_addr_lo = {w_addr_lo_hi, w_addr_lo_lo};	// src/main/scala/amba/axi4/SRAM.scala:66:21
  wire [1:0]  w_addr_hi_lo = nodeIn_aw_bits_addr[8:7];	// src/main/scala/amba/axi4/SRAM.scala:66:21, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [1:0]  w_addr_hi_hi_hi = nodeIn_aw_bits_addr[11:10];	// src/main/scala/amba/axi4/SRAM.scala:66:21, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [2:0]  w_addr_hi_hi = {w_addr_hi_hi_hi, nodeIn_aw_bits_addr[9]};	// src/main/scala/amba/axi4/SRAM.scala:66:{21,49,73}, src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire        r_sel0 = nodeIn_ar_bits_addr[30:12] == 19'h60000;	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/diplomacy/Parameters.scala:137:{31,59}
  wire        w_sel0 = nodeIn_aw_bits_addr[30:12] == 19'h60000;	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/diplomacy/Parameters.scala:137:{31,59}
