...
module AsyncQueueSink(
  ...
  input  [1:0]  io_async_mem_0_param,	// src/main/scala/util/AsyncQueue.scala:135:14
                io_async_mem_0_size,	// src/main/scala/util/AsyncQueue.scala:135:14
  input         io_async_mem_0_source,	// src/main/scala/util/AsyncQueue.scala:135:14
                io_async_mem_0_sink,	// src/main/scala/util/AsyncQueue.scala:135:14
                io_async_mem_0_denied,	// src/main/scala/util/AsyncQueue.scala:135:14
  input  [31:0] io_async_mem_0_data,	// src/main/scala/util/AsyncQueue.scala:135:14
  input         io_async_mem_0_corrupt,	// src/main/scala/util/AsyncQueue.scala:135:14
                io_async_widx,	// src/main/scala/util/AsyncQueue.scala:135:14
                io_async_safe_widx_valid,	// src/main/scala/util/AsyncQueue.scala:135:14
  ...
  output        io_deq_bits_corrupt,	// src/main/scala/util/AsyncQueue.scala:135:14
                io_async_ridx,	// src/main/scala/util/AsyncQueue.scala:135:14
                io_async_safe_ridx_valid,	// src/main/scala/util/AsyncQueue.scala:135:14
                io_async_safe_sink_reset_n	// src/main/scala/util/AsyncQueue.scala:135:14
);

  wire        _io_deq_valid_output;	// src/main/scala/util/AsyncQueue.scala:162:29
  ...
  assign ridx_incremented =
    source_ready & ridx_ridx_bin + (io_deq_ready & _io_deq_valid_output);	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/util/AsyncQueue.scala:51:27, :52:25, :53:{23,43}, :143:30, :162:29
  ...
  wire [32:0] io_deq_bits_deq_bits_reg_io_d_lo_lo =
    {io_async_mem_0_data, io_async_mem_0_corrupt};	// src/main/scala/util/SynchronizerReg.scala:209:24
  wire [1:0]  io_deq_bits_deq_bits_reg_io_d_lo_hi =
    {io_async_mem_0_sink, io_async_mem_0_denied};	// src/main/scala/util/SynchronizerReg.scala:209:24
  ...
  wire [2:0]  io_deq_bits_deq_bits_reg_io_d_hi_lo =
    {io_async_mem_0_size, io_async_mem_0_source};	// src/main/scala/util/SynchronizerReg.scala:209:24
  wire [4:0]  io_deq_bits_deq_bits_reg_io_d_hi_hi =
    {io_async_mem_0_opcode, io_async_mem_0_param};	// src/main/scala/util/SynchronizerReg.scala:209:24
  ...
  assign _io_deq_valid_output = valid_reg & source_ready;	// src/main/scala/util/AsyncQueue.scala:143:30, :161:56, :162:29
  ...
  AsyncValidSync sink_valid_0 (	// src/main/scala/util/AsyncQueue.scala:168:33
    .io_in  (1'h1),
    .clock  (clock),
    .reset  (reset | ~io_async_safe_source_reset_n),	// src/main/scala/util/AsyncQueue.scala:173:{42,45}
  ...
  AsyncValidSync sink_valid_1 (	// src/main/scala/util/AsyncQueue.scala:169:33
    ...
    .clock  (clock),
    .reset  (reset | ~io_async_safe_source_reset_n),	// src/main/scala/util/AsyncQueue.scala:173:45, :174:42
  ...
  AsyncValidSync source_extend (	// src/main/scala/util/AsyncQueue.scala:171:31
    ...
    .clock  (clock),
    .reset  (reset | ~io_async_safe_source_reset_n),	// src/main/scala/util/AsyncQueue.scala:173:45, :175:42
  ...
  assign io_deq_valid = _io_deq_valid_output;	// src/main/scala/util/AsyncQueue.scala:162:29
  assign io_deq_bits_opcode = _io_deq_bits_deq_bits_reg_io_q[42:40];	// src/main/scala/util/SynchronizerReg.scala:207:25, :211:26
  assign io_deq_bits_param = _io_deq_bits_deq_bits_reg_io_q[39:38];	// src/main/scala/util/SynchronizerReg.scala:207:25, :211:26
  assign io_deq_bits_size = _io_deq_bits_deq_bits_reg_io_q[37:36];	// src/main/scala/util/SynchronizerReg.scala:207:25, :211:26
  assign io_deq_bits_source = _io_deq_bits_deq_bits_reg_io_q[35];	// src/main/scala/util/SynchronizerReg.scala:207:25, :211:26
  assign io_deq_bits_sink = _io_deq_bits_deq_bits_reg_io_q[34];	// src/main/scala/util/SynchronizerReg.scala:207:25, :211:26
  assign io_deq_bits_denied = _io_deq_bits_deq_bits_reg_io_q[33];	// src/main/scala/util/SynchronizerReg.scala:207:25, :211:26
  assign io_deq_bits_data = _io_deq_bits_deq_bits_reg_io_q[32:1];	// src/main/scala/util/SynchronizerReg.scala:207:25, :211:26
  assign io_deq_bits_corrupt = _io_deq_bits_deq_bits_reg_io_q[0];	// src/main/scala/util/SynchronizerReg.scala:207:25, :211:26
  assign io_async_ridx = ridx_gray;	// src/main/scala/util/AsyncQueue.scala:164:55
