...
module Queue_101(
  ...
  reg  [59:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[1'h0][31:1], _RANDOM[1'h1][28:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  assign io_deq_bits_addr = empty ? io_enq_bits_addr : ram[34:4];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_len = empty ? io_enq_bits_len : ram[42:35];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_size = empty ? io_enq_bits_size : ram[45:43];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_burst = empty ? io_enq_bits_burst : ram[47:46];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_lock = empty ? io_enq_bits_lock : ram[48];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_cache = empty ? io_enq_bits_cache : ram[52:49];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_prot = empty ? io_enq_bits_prot : ram[55:53];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  assign io_deq_bits_qos = empty ? io_enq_bits_qos : ram[59:56];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
endmodule
