...
module Queue_37(
  ...
  reg  [65:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][2:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  assign io_deq_bits_size = ram[9:6];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_source = ram[14:10];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
