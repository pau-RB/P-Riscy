...
module Repeater_9(
  ...
  input  [16:0] io_enq_bits_address,	// src/main/scala/util/Repeater.scala:12:14
  ...
  output [16:0] io_deq_bits_address,	// src/main/scala/util/Repeater.scala:12:14
  ...
  reg  [16:0] saved_address;	// src/main/scala/util/Repeater.scala:20:18
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_address = _RANDOM[2'h0][31:15];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_mask = _RANDOM[2'h1][3:0];	// src/main/scala/util/Repeater.scala:20:18
        saved_data = {_RANDOM[2'h1][31:4], _RANDOM[2'h2][3:0]};	// src/main/scala/util/Repeater.scala:20:18
        saved_corrupt = _RANDOM[2'h2][4];	// src/main/scala/util/Repeater.scala:20:18
      `endif // RANDOMIZE_REG_INIT
    end // initial
