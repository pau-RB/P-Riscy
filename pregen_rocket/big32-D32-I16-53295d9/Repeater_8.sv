  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_opcode = _RANDOM[1'h0][3:1];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_param = _RANDOM[1'h0][6:4];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_size = _RANDOM[1'h0][9:7];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_source = _RANDOM[1'h0][14:10];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_address = _RANDOM[1'h0][26:15];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_mask = _RANDOM[1'h0][30:27];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_data = {_RANDOM[1'h0][31], _RANDOM[1'h1][30:0]};	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_corrupt = _RANDOM[1'h1][31];	// src/main/scala/util/Repeater.scala:20:18
      `endif // RANDOMIZE_REG_INIT
    end // initial
