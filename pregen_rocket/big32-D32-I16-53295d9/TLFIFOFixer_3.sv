...
module TLFIFOFixer_3(
  ...
  wire [4:0]  nodeOut_a_bits_source = nodeIn_a_bits_source;	// src/main/scala/diplomacy/Nodes.scala:1205:17, :1214:17
  ...
  wire [2:0]  a_id =
    ...
    | ({nodeIn_a_bits_address[27],
        ...
        ~(nodeIn_a_bits_address[16])} == 3'h0
         ? 3'h5
         : 3'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/diplomacy/Parameters.scala:52:29, :137:{31,41,59}
  ...
  wire [18:0] SourceIdSet = a_first & _T_5 ? _SourceIdSet_T[18:0] : 19'h0;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/chisel3/util/OneHot.scala:58:35, src/main/scala/tilelink/Edges.scala:232:25, src/main/scala/tilelink/FIFOFixer.scala:109:35, :110:36, :113:{21,50}, :114:21
  ...
  wire [18:0] SourceIdClear = d_first & _T_9 ? _SourceIdClear_T[18:0] : 19'h0;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/chisel3/util/OneHot.scala:58:35, src/main/scala/tilelink/FIFOFixer.scala:69:42, :109:35, :111:38, :116:{21,36}, :117:23
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      flight_0 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'h0)
        & (_T_1 & nodeIn_a_bits_source == 5'h0 | flight_0);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_1 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'h1)
        & (_T_1 & nodeIn_a_bits_source == 5'h1 | flight_1);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_2 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'h2)
        & (_T_1 & nodeIn_a_bits_source == 5'h2 | flight_2);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_3 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'h3)
        & (_T_1 & nodeIn_a_bits_source == 5'h3 | flight_3);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_4 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'h4)
        & (_T_1 & nodeIn_a_bits_source == 5'h4 | flight_4);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_5 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'h5)
        & (_T_1 & nodeIn_a_bits_source == 5'h5 | flight_5);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_6 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'h6)
        & (_T_1 & nodeIn_a_bits_source == 5'h6 | flight_6);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_7 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'h7)
        & (_T_1 & nodeIn_a_bits_source == 5'h7 | flight_7);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_8 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'h8)
        & (_T_1 & nodeIn_a_bits_source == 5'h8 | flight_8);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_9 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'h9)
        & (_T_1 & nodeIn_a_bits_source == 5'h9 | flight_9);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_10 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'hA)
        & (_T_1 & nodeIn_a_bits_source == 5'hA | flight_10);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_11 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'hB)
        & (_T_1 & nodeIn_a_bits_source == 5'hB | flight_11);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_12 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'hC)
        & (_T_1 & nodeIn_a_bits_source == 5'hC | flight_12);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_13 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'hD)
        & (_T_1 & nodeIn_a_bits_source == 5'hD | flight_13);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_14 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'hE)
        & (_T_1 & nodeIn_a_bits_source == 5'hE | flight_14);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_15 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'hF)
        & (_T_1 & nodeIn_a_bits_source == 5'hF | flight_15);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_16 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'h10)
        & (_T_1 & nodeIn_a_bits_source == 5'h10 | flight_16);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_17 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'h11)
        & (_T_1 & nodeIn_a_bits_source == 5'h11 | flight_17);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_18 <=
        ~(_T_3 & nodeIn_d_bits_source == 5'h12)
        & (_T_1 & nodeIn_a_bits_source == 5'h12 | flight_18);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        flight_16 = _RANDOM[1'h1][4];	// src/main/scala/tilelink/FIFOFixer.scala:73:27
        flight_17 = _RANDOM[1'h1][5];	// src/main/scala/tilelink/FIFOFixer.scala:73:27
        flight_18 = _RANDOM[1'h1][6];	// src/main/scala/tilelink/FIFOFixer.scala:73:27
        stalls_id = _RANDOM[1'h1][9:7];	// src/main/scala/tilelink/FIFOFixer.scala:73:27, :79:30
        stalls_id_1 = _RANDOM[1'h1][12:10];	// src/main/scala/tilelink/FIFOFixer.scala:73:27, :79:30
        SourceIdFIFOed = _RANDOM[1'h1][31:13];	// src/main/scala/tilelink/FIFOFixer.scala:73:27, :109:35
      `endif // RANDOMIZE_REG_INIT
    end // initial
