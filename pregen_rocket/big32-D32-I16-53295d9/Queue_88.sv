...
module Queue_88(
  ...
  wire [6:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  ram_combMem_0 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_echo_real_last, io_enq_bits_resp, io_enq_bits_id}),	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  assign io_deq_bits_resp = _ram_ext_R0_data[5:4];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_echo_real_last = _ram_ext_R0_data[6];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
