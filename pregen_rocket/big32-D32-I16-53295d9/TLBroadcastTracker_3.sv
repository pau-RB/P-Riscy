...
module TLBroadcastTracker_3(
  ...
  input  [3:0]  io_in_a_bits_mask,	// src/main/scala/tilelink/Broadcast.scala:401:14
  input  [31:0] io_in_a_bits_data,	// src/main/scala/tilelink/Broadcast.scala:401:14
  ...
  output        io_out_a_bits_user_amba_prot_bufferable,	// src/main/scala/tilelink/Broadcast.scala:401:14
                io_out_a_bits_user_amba_prot_modifiable,	// src/main/scala/tilelink/Broadcast.scala:401:14
                io_out_a_bits_user_amba_prot_readalloc,	// src/main/scala/tilelink/Broadcast.scala:401:14
                io_out_a_bits_user_amba_prot_writealloc,	// src/main/scala/tilelink/Broadcast.scala:401:14
                io_out_a_bits_user_amba_prot_privileged,	// src/main/scala/tilelink/Broadcast.scala:401:14
                io_out_a_bits_user_amba_prot_secure,	// src/main/scala/tilelink/Broadcast.scala:401:14
                io_out_a_bits_user_amba_prot_fetch,	// src/main/scala/tilelink/Broadcast.scala:401:14
  output [3:0]  io_out_a_bits_mask,	// src/main/scala/tilelink/Broadcast.scala:401:14
  output [31:0] io_out_a_bits_data,	// src/main/scala/tilelink/Broadcast.scala:401:14
  ...
  wire [3:0]  i_data_bits_mask = io_in_a_bits_mask;	// src/main/scala/tilelink/Broadcast.scala:483:20
  wire [31:0] i_data_bits_data = io_in_a_bits_data;	// src/main/scala/tilelink/Broadcast.scala:483:20
  ...
  reg         user_amba_prot_bufferable;	// src/main/scala/tilelink/Broadcast.scala:431:20
  reg         user_amba_prot_modifiable;	// src/main/scala/tilelink/Broadcast.scala:431:20
  reg         user_amba_prot_readalloc;	// src/main/scala/tilelink/Broadcast.scala:431:20
  reg         user_amba_prot_writealloc;	// src/main/scala/tilelink/Broadcast.scala:431:20
  reg         user_amba_prot_privileged;	// src/main/scala/tilelink/Broadcast.scala:431:20
  reg         user_amba_prot_secure;	// src/main/scala/tilelink/Broadcast.scala:431:20
  reg         user_amba_prot_fetch;	// src/main/scala/tilelink/Broadcast.scala:431:20
  ...
  wire        _T_1 = _io_in_a_ready_output & io_in_a_valid & io_in_a_first;	// src/main/scala/tilelink/Broadcast.scala:438:22, :486:45
  ...
  wire        probe_done = ~count;	// src/main/scala/tilelink/Broadcast.scala:434:20, :491:26
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      address <= 32'hC0;	// src/main/scala/tilelink/Broadcast.scala:433:24
    end
    else begin
      got_e <=
        io_e_last
        | (_T_1 ? io_in_a_bits_opcode != 3'h6 & io_in_a_bits_opcode != 3'h7 : got_e);	// src/main/scala/tilelink/Broadcast.scala:424:24, :438:{22,40}, :442:{13,36,64,87}, :463:20, :465:11
      sent_d <= io_d_last | ~_T_1 & sent_d;	// src/main/scala/tilelink/Broadcast.scala:425:24, :438:{22,40}, :440:13, :459:20, :461:12
      if (_T_1)	// src/main/scala/tilelink/Broadcast.scala:438:22
    ...
    if (io_probesack)
      ...
      shared <= ~_T_1 & shared;	// src/main/scala/tilelink/Broadcast.scala:425:24, :426:20, :438:{22,40}, :440:13, :441:13
    if (_T_1) begin	// src/main/scala/tilelink/Broadcast.scala:438:22
    ...
    user_amba_prot_bufferable <= ~_T_1 & user_amba_prot_bufferable;	// src/main/scala/tilelink/Broadcast.scala:425:24, :431:20, :438:{22,40}, :440:13, :447:12
    user_amba_prot_modifiable <= ~_T_1 & user_amba_prot_modifiable;	// src/main/scala/tilelink/Broadcast.scala:425:24, :431:20, :438:{22,40}, :440:13, :447:12
    user_amba_prot_readalloc <= ~_T_1 & user_amba_prot_readalloc;	// src/main/scala/tilelink/Broadcast.scala:425:24, :431:20, :438:{22,40}, :440:13, :447:12
    user_amba_prot_writealloc <= ~_T_1 & user_amba_prot_writealloc;	// src/main/scala/tilelink/Broadcast.scala:425:24, :431:20, :438:{22,40}, :440:13, :447:12
    user_amba_prot_privileged <= ~_T_1 & user_amba_prot_privileged;	// src/main/scala/tilelink/Broadcast.scala:425:24, :431:20, :438:{22,40}, :440:13, :447:12
    user_amba_prot_secure <= ~_T_1 & user_amba_prot_secure;	// src/main/scala/tilelink/Broadcast.scala:425:24, :431:20, :438:{22,40}, :440:13, :447:12
    user_amba_prot_fetch <= ~_T_1 & user_amba_prot_fetch;	// src/main/scala/tilelink/Broadcast.scala:425:24, :431:20, :438:{22,40}, :440:13, :447:12
    if (_T_13)	// src/main/scala/tilelink/Broadcast.scala:468:22
      ...
      count <= _T_1 | count;	// src/main/scala/tilelink/Broadcast.scala:434:20, :438:{22,40}, :450:13
    if (io_probe_valid)
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// src/main/scala/tilelink/Broadcast.scala:439:12
      if (_T_1 & ~reset & ~idle) begin	// src/main/scala/tilelink/Broadcast.scala:436:23, :438:22, :439:12
      ...
      if (io_d_last & ~reset & sent_d) begin	// src/main/scala/tilelink/Broadcast.scala:425:24, :460:12
      ...
      if (io_e_last & ~reset & got_e) begin	// src/main/scala/tilelink/Broadcast.scala:424:24, :464:12
      ...
      if (_T_13 & ~reset & ~count) begin	// src/main/scala/tilelink/Broadcast.scala:434:20, :468:22, :469:12
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        user_amba_prot_bufferable = _RANDOM[1'h0][17];	// src/main/scala/tilelink/Broadcast.scala:424:24, :431:20
        user_amba_prot_modifiable = _RANDOM[1'h0][18];	// src/main/scala/tilelink/Broadcast.scala:424:24, :431:20
        user_amba_prot_readalloc = _RANDOM[1'h0][19];	// src/main/scala/tilelink/Broadcast.scala:424:24, :431:20
        user_amba_prot_writealloc = _RANDOM[1'h0][20];	// src/main/scala/tilelink/Broadcast.scala:424:24, :431:20
        user_amba_prot_privileged = _RANDOM[1'h0][21];	// src/main/scala/tilelink/Broadcast.scala:424:24, :431:20
        user_amba_prot_secure = _RANDOM[1'h0][22];	// src/main/scala/tilelink/Broadcast.scala:424:24, :431:20
        user_amba_prot_fetch = _RANDOM[1'h0][23];	// src/main/scala/tilelink/Broadcast.scala:424:24, :431:20
        address = {_RANDOM[1'h0][31:24], _RANDOM[1'h1][23:0]};	// src/main/scala/tilelink/Broadcast.scala:424:24, :433:24
        count = _RANDOM[1'h1][24];	// src/main/scala/tilelink/Broadcast.scala:433:24, :434:20
        cacheOH = _RANDOM[1'h1][25];	// src/main/scala/tilelink/Broadcast.scala:433:24, :435:20
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_74 o_data_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
  ...
  assign io_out_a_valid = _o_data_q_io_deq_valid & probe_done;	// src/main/scala/chisel3/util/Decoupled.scala:376:21, src/main/scala/tilelink/Broadcast.scala:491:26, :497:34
  ...
  assign io_out_a_bits_user_amba_prot_bufferable = user_amba_prot_bufferable;	// src/main/scala/tilelink/Broadcast.scala:431:20
  assign io_out_a_bits_user_amba_prot_modifiable = user_amba_prot_modifiable;	// src/main/scala/tilelink/Broadcast.scala:431:20
  assign io_out_a_bits_user_amba_prot_readalloc = user_amba_prot_readalloc;	// src/main/scala/tilelink/Broadcast.scala:431:20
  assign io_out_a_bits_user_amba_prot_writealloc = user_amba_prot_writealloc;	// src/main/scala/tilelink/Broadcast.scala:431:20
  assign io_out_a_bits_user_amba_prot_privileged = user_amba_prot_privileged;	// src/main/scala/tilelink/Broadcast.scala:431:20
  assign io_out_a_bits_user_amba_prot_secure = user_amba_prot_secure;	// src/main/scala/tilelink/Broadcast.scala:431:20
  assign io_out_a_bits_user_amba_prot_fetch = user_amba_prot_fetch;	// src/main/scala/tilelink/Broadcast.scala:431:20
