...
module TLFragmenter_2(
  ...
  input  [11:0] auto_in_a_bits_address,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  output [11:0] auto_out_a_bits_address,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  wire [11:0] _repeater_io_deq_bits_address;	// src/main/scala/tilelink/Fragmenter.scala:264:30
  ...
  wire [11:0] nodeIn_a_bits_address = auto_in_a_bits_address;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire        ack_decrement = dHasData | dsizeOH[2];	// src/main/scala/chisel3/util/OneHot.scala:65:27, src/main/scala/tilelink/Edges.scala:107:36, src/main/scala/tilelink/Fragmenter.scala:206:{32,56}
  ...
  wire [1:0]  aMask = aHasData ? 2'h0 : aFragOH1;	// src/main/scala/diplomacy/LazyModule.scala:374:18, src/main/scala/tilelink/Edges.scala:93:28, src/main/scala/tilelink/Fragmenter.scala:291:24, src/main/scala/util/package.scala:243:46
  ...
  wire [11:0] nodeOut_a_bits_address =
    ...
    if (reset) begin
      ...
      if (_T_7) begin	// src/main/scala/chisel3/util/Decoupled.scala:52:35
        if (dFirst)	// src/main/scala/tilelink/Fragmenter.scala:195:29
          ...
          acknum <= acknum - {3'h0, ack_decrement};	// src/main/scala/chisel3/util/OneHot.scala:65:12, src/main/scala/tilelink/Fragmenter.scala:191:29, :206:32, :211:55
      end
  ...
  Repeater_8 repeater (	// src/main/scala/tilelink/Fragmenter.scala:264:30
    .clock               (clock),
    .reset               (reset),
