  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_address = {_RANDOM[5'h0][31:16], _RANDOM[5'h1][11:0]};	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_mask = {_RANDOM[5'h1][31:12], _RANDOM[5'h2], _RANDOM[5'h3][11:0]};	// src/main/scala/util/Repeater.scala:20:18
        saved_data =
          {_RANDOM[5'h3][31:12],
           _RANDOM[5'h4],
           _RANDOM[5'h5],
           ...
           _RANDOM[5'h11],
           _RANDOM[5'h12],
           _RANDOM[5'h13][11:0]};	// src/main/scala/util/Repeater.scala:20:18
        saved_corrupt = _RANDOM[5'h13][12];	// src/main/scala/util/Repeater.scala:20:18
      `endif // RANDOMIZE_REG_INIT
    end // initial
