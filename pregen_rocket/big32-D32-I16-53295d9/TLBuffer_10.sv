...
module TLBuffer_10(
  ...
  input  [1:0]   auto_in_a_bits_source,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  input          auto_in_b_ready,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  input  [3:0]   auto_in_c_bits_size,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  input  [1:0]   auto_in_c_bits_source,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  output [2:0]   auto_in_b_bits_opcode,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  output [1:0]   auto_in_b_bits_param,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  output [3:0]   auto_in_b_bits_size,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  output [1:0]   auto_in_b_bits_source,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  output [31:0]  auto_in_b_bits_address,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  output [63:0]  auto_in_b_bits_mask,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  output [511:0] auto_in_b_bits_data,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  output [1:0]   auto_in_d_bits_source,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  output         auto_in_d_bits_corrupt,	// src/main/scala/diplomacy/LazyModule.scala:374:18
                 auto_in_e_ready,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  wire [511:0] nodeOut_c_bits_data;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire         nodeOut_c_bits_user_amba_prot_fetch;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire         nodeOut_c_bits_user_amba_prot_secure;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire         nodeOut_c_bits_user_amba_prot_privileged;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire         nodeOut_c_bits_user_amba_prot_writealloc;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire         nodeOut_c_bits_user_amba_prot_readalloc;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire         nodeOut_c_bits_user_amba_prot_modifiable;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire         nodeOut_c_bits_user_amba_prot_bufferable;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  wire [511:0] nodeIn_b_bits_data;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [63:0]  nodeIn_b_bits_mask;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [1:0]   nodeIn_a_bits_source = auto_in_a_bits_source;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [3:0]   nodeIn_c_bits_size = auto_in_c_bits_size;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [1:0]   nodeIn_c_bits_source = auto_in_c_bits_source;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire         nodeIn_c_bits_corrupt = 1'h0;	// src/main/scala/diplomacy/LazyModule.scala:374:18, src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [3:0]   nodeOut_b_bits_size = 4'h6;	// src/main/scala/diplomacy/LazyModule.scala:374:18, src/main/scala/diplomacy/Nodes.scala:1205:17
  wire [1:0]   nodeOut_b_bits_source = 2'h0;	// src/main/scala/diplomacy/LazyModule.scala:374:18, src/main/scala/diplomacy/Nodes.scala:1205:17
  wire [63:0]  nodeOut_b_bits_mask = 64'hFFFFFFFFFFFFFFFF;	// src/main/scala/diplomacy/LazyModule.scala:374:18, src/main/scala/diplomacy/Nodes.scala:1205:17
  wire [511:0] nodeOut_b_bits_data = 512'h0;	// src/main/scala/diplomacy/LazyModule.scala:374:18, src/main/scala/diplomacy/Nodes.scala:1205:17
  wire         nodeOut_e_ready = 1'h1;	// src/main/scala/diplomacy/LazyModule.scala:374:18, src/main/scala/diplomacy/Nodes.scala:1205:17
  Queue_78 nodeOut_a_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock                                 (clock),
    .reset                                 (reset),
  ...
  Queue_79 nodeIn_d_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_80 nodeIn_b_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock               (clock),
    .reset               (reset),
    ...
    .io_enq_bits_corrupt (nodeOut_b_bits_corrupt),	// src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  Queue_81 nodeOut_c_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock                                 (clock),
    .reset                                 (reset),
    ...
    .io_deq_bits_user_amba_prot_bufferable (nodeOut_c_bits_user_amba_prot_bufferable),
    .io_deq_bits_user_amba_prot_modifiable (nodeOut_c_bits_user_amba_prot_modifiable),
    .io_deq_bits_user_amba_prot_readalloc  (nodeOut_c_bits_user_amba_prot_readalloc),
    .io_deq_bits_user_amba_prot_writealloc (nodeOut_c_bits_user_amba_prot_writealloc),
    .io_deq_bits_user_amba_prot_privileged (nodeOut_c_bits_user_amba_prot_privileged),
    .io_deq_bits_user_amba_prot_secure     (nodeOut_c_bits_user_amba_prot_secure),
    .io_deq_bits_user_amba_prot_fetch      (nodeOut_c_bits_user_amba_prot_fetch),
    .io_deq_bits_data                      (nodeOut_c_bits_data),
    .io_deq_bits_corrupt                   (nodeOut_c_bits_corrupt)
  );
  Queue_82 nodeOut_e_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
  ...
  assign auto_in_b_bits_opcode = nodeIn_b_bits_opcode;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  assign auto_in_b_bits_param = nodeIn_b_bits_param;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  assign auto_in_b_bits_size = nodeIn_b_bits_size;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  assign auto_in_b_bits_source = nodeIn_b_bits_source;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  assign auto_in_b_bits_address = nodeIn_b_bits_address;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  assign auto_in_b_bits_mask = nodeIn_b_bits_mask;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  assign auto_in_b_bits_data = nodeIn_b_bits_data;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  assign auto_in_e_ready = nodeIn_e_ready;	// src/main/scala/diplomacy/Nodes.scala:1214:17
