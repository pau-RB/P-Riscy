  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_mask = _RANDOM[2'h1][12:9];	// src/main/scala/util/Repeater.scala:20:18
        saved_data = {_RANDOM[2'h1][31:13], _RANDOM[2'h2][12:0]};	// src/main/scala/util/Repeater.scala:20:18
        saved_corrupt = _RANDOM[2'h2][13];	// src/main/scala/util/Repeater.scala:20:18
      `endif // RANDOMIZE_REG_INIT
    end // initial
