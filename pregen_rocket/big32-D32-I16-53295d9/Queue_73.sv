...
module Queue_73(
  ...
  reg  [75:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][12:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  assign io_deq_bits_id = ram[6:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_addr = ram[38:7];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_len = ram[46:39];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_size = ram[49:47];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_burst = ram[51:50];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_lock = ram[52];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_cache = ram[56:53];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_prot = ram[59:57];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_qos = ram[63:60];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_echo_tl_state_size = ram[67:64];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_echo_tl_state_source = ram[74:68];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_wen = ram[75];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
